function layoutSettings() {
    wW = window.innerWidth,
        ...
        wW <= 740 ? slider || initSlider() : slider && (slider.destroy(),
            slider = null,
            $(".swiper-slide").width("")),
    ...
    t.index = e,
        ...
        t.animate = function (e, i) {
            ...
            if (i) {
                ...
                TweenMax.to(iPhone, trValues[t.index].iPhone.duration, trValues[t.index].iPhone.values),
                    r / 180 % 2 !== 0 ? TweenMax.to(stripe, .5, {
                        delay: .2,
                        y: 0,
                        scaleX: 1.3,
                        force3D: !0,
                ...
                TweenMax.to(stripe, trValues[t.index].stripe.duration, trValues[t.index].stripe.values),
                    TweenMax.to(iPhone, trValues[t.index].iPhone.duration, trValues[t.index].iPhone.values);
            ...
            if (currentSection >= 0 && currentSection <= 4) {
                ...
                if (currentSection === 4) {
                    if (!$('#sub-nav').hasClass('hide-download')) {
                        $('#sub-nav').addClass('hide-download');
                    }
                } else if ($('#sub-nav').hasClass('hide-download')) {
                    $('#sub-nav').removeClass('hide-download');
                }
            }
            ...
            //     case 0:
            //         upText.removeClass('white');
            //         downText.removeClass('white');
            //         break;
            //     case 1:
            //         upText.removeClass('white');
            //         if (!downText.hasClass('white')) {
            //             downText.addClass('white');
            //         }
            //         break;
            //     case 2:
            //         if (!upText.hasClass('white')) {
            //             upText.addClass('white');
            //         }
            //         downText.removeClass('white');
            //         break;
            //     case 3:
...
function TabletScroll() {
    this.init = function () {
        touchmoveDisabled = !0,
            $(document).on("touchend", initiPadVideo),
            $(document).swipe({
                threshold: 100,
...
function initiPadVideo() {
    // video.play(),
    //     video.pause(),
    $(document).off("touchend", initiPadVideo)
}

function getTransitionValuesNew() {
    trValues[0] = {
        stripe: {
            duration: .5,
            values: {
...
function rotateSlide(e, t) {
    var i, n = lastSwipeProgress - t, r = n * (slidesNumber - 1), s = $("#slider-images span").eq(e.activeIndex),
        a = n < 0 ? $("#slider-images span").eq(e.activeIndex + 1) : $("#slider-images span").eq(e.activeIndex - 1),
        o = Math.min(90, 90 * r);
    r >= 0 ? i = Math.max(-90, -90 + 90 * r) : r < 0 && (i = Math.min(90, 90 - r * -90)),
        setTimeout(function () {
            s.css({
...
function sendForm() {
    ...
    //     },
    //     success: function (e) {
    //         "ok" === e.status ? ($("#email").blur(),
    //             $("#newsletter-form").addClass("success").removeClass("sendable"),
    //             setTimeout(function () {
    //                 $("#newsletter-form").removeClass("success").addClass("sendable")
    //             }, 5e3)) : $("#error-tag").text(e.message).addClass("visible"),
    //             submitBtn.removeAttr("disabled").removeClass("sending")
    //     }
    // })
}
...
!function (e, t) {
    ...
    function l(e, t, i) {
        ...
        if (void 0 === i && 1 === e.nodeType)
            if (n = "data-" + t.replace(we, "-$1").toLowerCase(),
                    i = e.getAttribute(n),
                "string" == typeof i) {
                try {
        ...
        if (1 === t.nodeType) {
            if (ve.hasData(e) && (s = ve.access(e),
                ...
                for (r in u)
                    for (i = 0,
                             n = u[r].length; n > i; i++)
                        J.event.add(t, r, u[r][i])
            }
            _e.hasData(e) && (o = _e.access(e),
                l = J.extend({}, o),
                _e.set(t, l))
        }
    }
    ...
    function w(e) {
        var t = Z
            , i = Be[e];
        return i || (i = y(e, t),
        "none" !== i && i || (je = (je || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
    ...
    function x(e, t, i) {
        ...
        i && ("" !== a || J.contains(e.ownerDocument, e) || (a = J.style(e, t)),
        qe.test(a) && Xe.test(t) && (n = o.width,
            r = o.minWidth,
            s = o.maxWidth,
    ...
    function C(e, t, i, n, r) {
        for (var s = i === (n ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > s; s += 2)
            "margin" === i && (a += J.css(e, i + be[s], !0, r)),
                n ? ("content" === i && (a -= J.css(e, "padding" + be[s], !0, r)),
                "margin" !== i && (a -= J.css(e, "border" + be[s] + "Width", !0, r))) : (a += J.css(e, "padding" + be[s], !0, r),
                "padding" !== i && (a += J.css(e, "border" + be[s] + "Width", !0, r)));
        return a
    }
        ...
        if (0 >= r || null == r) {
            if (r = x(e, t, s),
                (0 > r || null == r) && (r = e.style[t]),
                    qe.test(r))
                return r;
            n = a && (Q.boxSizingReliable() || r === e.style[t]),
                r = parseFloat(r) || 0
        }
    ...
    function k(e, t) {
        for (var i, n, r, s = [], a = 0, o = e.length; o > a; a++)
            n = e[a],
            n.style && (s[a] = ve.get(n, "olddisplay"),
                i = n.style.display,
                t ? (s[a] || "none" !== i || (n.style.display = ""),
                "" === n.style.display && Te(n) && (s[a] = ve.access(n, "olddisplay", w(n.nodeName)))) : (r = Te(n),
                "none" === i && r || ve.set(n, "olddisplay", r ? i : J.css(n, "display"))));
        for (a = 0; o > a; a++)
            n = e[a],
            n.style && (t && "none" !== n.style.display && "" !== n.style.display || (n.style.display = t ? s[a] || "" : "none"));
        return e
    }
    ...
    function A(e, t, i) {
        var n, r, s, a, o, l, u, c, p = this, h = {}, d = e.style, f = e.nodeType && Te(e), m = ve.get(e, "fxshow");
        i.queue || (o = J._queueHooks(e, "fx"),
        null == o.unqueued && (o.unqueued = 0,
            ...
            p.always(function () {
                p.always(function () {
                    o.unqueued--,
                    J.queue(e, "fx").length || o.empty.fire()
                })
            })),
        ...
        "inline" === c && "none" === J.css(e, "float") && (d.display = "inline-block")),
        ...
        if (J.isEmptyObject(h))
            "inline" === ("none" === u ? w(e.nodeName) : u) && (d.display = u);
        else {
    ...
    function N(e, t, i) {
        var n, r, s = 0, a = tt.length, o = J.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (r)
                return !1;
            for (var t = Qe || O(), i = Math.max(0, u.startTime + u.duration - t), n = i / u.duration || 0, s = 1 - n, a = 0, l = u.tweens.length; l > a; a++)
                u.tweens[a].run(s);
            return o.notifyWith(e, [u, s, i]),
                1 > s && l ? i : (o.resolveWith(e, [u]),
                    !1)
        }, u = o.promise({
            elem: e,
            props: J.extend({}, t),
            ...
            stop: function (t) {
                ...
                for (r = !0; n > i; i++)
                    u.tweens[i].run(1);
                return t ? o.resolveWith(e, [u, t]) : o.rejectWith(e, [u, t]),
                    this
            }
        }), c = u.props;
        for (R(c, u.opts.specialEasing); a > s; s++)
            if (n = tt[s].call(u, e, c, u.opts))
                return n;
        return J.map(c, M, u),
    ...
    function L(e) {
        return function (t, i) {
            "string" != typeof t && (i = t,
                t = "*");
            var n, r = 0, s = t.toLowerCase().match(de) || [];
            if (J.isFunction(i))
                for (; n = s[r++];)
                    "+" === n[0] ? (n = n.slice(1) || "*",
    ...
    function I(e, t, i, n) {
        function r(o) {
            var l;
            return s[o] = !0,
                J.each(e[o] || [], function (e, o) {
                    var u = o(t, i, n);
                    return "string" != typeof u || a || s[u] ? a ? !(l = u) : void 0 : (t.dataTypes.unshift(u),
                        r(u),
                        !1)
                }),
                l
    ...
    J.fn = J.prototype = {
        ...
        J.extend = J.fn.extend = function () {
            var e, t, i, n, r, s, a = arguments[0] || {}, o = 1, l = arguments.length, u = !1;
            for ("boolean" == typeof a && (u = a,
                ...
                if (null != (e = arguments[o]))
                    for (t in e)
                        i = a[t],
                            n = e[t],
                        a !== n && (u && n && (J.isPlainObject(n) || (r = J.isArray(n))) ? (r ? (r = !1,
                            s = i && J.isArray(i) ? i : []) : s = i && J.isPlainObject(i) ? i : {},
                            a[t] = J.extend(u, s, n)) : void 0 !== n && (a[t] = n));
            return a
        }
        ,
        J.extend({
            ...
            globalEval: function (e) {
                ...
                e && (1 === e.indexOf("use strict") ? (t = Z.createElement("script"),
                    t.text = e,
                    Z.head.appendChild(t).parentNode.removeChild(t)) : i(e))
            },
            ...
            each: function (e, t, n) {
                var r, s = 0, a = e.length, o = i(e);
                if (n) {
                    if (o)
                        for (; a > s && (r = t.apply(e[s], n),
                        r !== !1); s++)
                            ;
                    else
                        for (s in e)
            ...
            makeArray: function (e, t) {
                var n = t || [];
                return null != e && (i(Object(e)) ? J.merge(n, "string" == typeof e ? [e] : e) : W.call(n, e)),
                    n
            },
            ...
            grep: function (e, t, i) {
                for (var n, r = [], s = 0, a = e.length, o = !i; a > s; s++)
                    n = !t(e[s], s),
                    n !== o && r.push(e[s]);
                return r
            },
            map: function (e, t, n) {
                var r, s = 0, a = e.length, o = i(e), l = [];
                if (o)
                    for (; a > s; s++)
                        r = t(e[s], s, n),
                        null != r && l.push(r);
            ...
            proxy: function (e, t) {
                ...
                return "string" == typeof t && (i = e[t],
                    t = e,
                    e = i),
                    J.isFunction(e) ? (n = H.call(arguments, 2),
                        r = function () {
    ...
    var re = function (e) {
        function t(e, t, i, n) {
            ...
            if ((t ? t.ownerDocument || t : B) !== A && M(t),
                    t = t || A,
                    i = i || [],
                !e || "string" != typeof e)
                return i;
            ...
            if (N && !n) {
                    ...
                    if (a = r[1]) {
                        if (9 === o) {
                            ...
                            if (s.id === a)
                                return i.push(s),
                                    i
                        } else if (t.ownerDocument && (s = t.ownerDocument.getElementById(a)) && F(t, s) && s.id === a)
                            return i.push(s),
                                i
                    } else {
                        if (r[2])
                            return J.apply(i, t.getElementsByTagName(e)),
                                i;
                        if ((a = r[3]) && x.getElementsByClassName && t.getElementsByClassName)
                ...
                if (x.qsa && (!L || !L.test(e))) {
                    if (d = p = j,
                        ...
                        for (u = C(e),
                                 (p = t.getAttribute("id")) ? d = p.replace(we, "\\$&") : t.setAttribute("id", d),
                                 d = "[id='" + d + "'] ",
                                 l = u.length; l--;)
                            u[l] = d + h(u[l]);
        ...
        function i() {
            function e(i, n) {
                return t.push(i + " ") > b.cacheLength && delete e[t.shift()],
                    e[i + " "] = n
            }
        ...
        function v(e, t, i, r, s, a) {
            ...
            s && !s[j] && (s = v(s, a)),
                n(function (n, a, o, l) {
                    var u, c, p, h = [], d = [], f = a.length, v = n || m(t || "*", o.nodeType ? [o] : o, []),
                        _ = !e || !n && t ? v : g(v, h, e, o, l), y = i ? s || (n ? e : f || r) ? [] : a : _;
                    if (i && i(_, y, o, l),
                            r)
                        for (u = g(y, d),
                                 r(u, [], o, l),
                    ...
                    if (n) {
                        if (s || e) {
                            ...
                            for (c = y.length; c--;)
                                (p = y[c]) && (u = s ? te.call(n, p) : h[c]) > -1 && (n[u] = !(a[u] = p))
                        }
                    } else
        ...
        function _(e) {
            for (var t, i, n, r = e.length, s = b.relative[e[0].type], a = s || b.relative[" "], o = s ? 1 : 0, l = d(function (e) {
                ...
                if (i = b.relative[e[o].type])
                    c = [d(f(c), i)];
                else {
                    if (i = b.filter[e[o].type].apply(null, e[o].matches),
                            i[j]) {
        ...
        function y(e, i) {
            var r = i.length > 0
                ...
                var c, p, h, d = 0, f = "0", m = n && [], v = [], _ = D, y = n || s && b.find.TAG("*", u),
                    w = X += null == _ ? 1 : Math.random() || .1, x = y.length;
                ...
                if (d += f,
                    ...
                    J.apply(l, v),
                    u && !n && v.length > 0 && d + i.length > 1 && t.uniqueSort(l)
                }
                return u && (X = w,
                    D = _),
                    m
        ...
        var w, x, b, T, S, C, P, k, D, O, E, M, A, R, N, L, I, z, F, j = "sizzle" + -new Date, B = e.document, X = 0,
            q = 0, H = i(), $ = i(), W = i(), V = function (e, t) {
                return e === t && (E = !0),
                    0
            }, Y = "undefined", G = 1 << 31, U = {}.hasOwnProperty, Q = [], Z = Q.pop, K = Q.push, J = Q.push, ee = Q.slice,
            ...
            ne = "[\\x20\\t\\r\\n\\f]", re = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", se = re.replace("w", "w#"),
            ae = "\\[" + ne + "*(" + re + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + se + "))|)" + ne + "*\\]",
            oe = ":(" + re + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ae + ")*)|.*)\\)|)",
            le = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$", "g"),
            ue = new RegExp("^" + ne + "*," + ne + "*"), ce = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"),
            pe = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), he = new RegExp(oe),
            de = new RegExp("^" + se + "$"), fe = {
                ID: new RegExp("^#(" + re + ")"),
                CLASS: new RegExp("^\\.(" + re + ")"),
            ...
            _e = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, we = /'|\\/g,
            xe = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), be = function (e, t, i) {
                var n = "0x" + t - 65536;
                return n !== n || i ? t : 0 > n ? String.fromCharCode(n + 65536) : String.fromCharCode(n >> 10 | 55296, 1023 & n | 56320)
            };
        try {
            J.apply(Q = ee.call(B.childNodes), B.childNodes),
        ...
        x = t.support = {},
            ...
            M = t.setDocument = function (e) {
                var t, i = e ? e.ownerDocument || e : B, n = i.defaultView;
                ...
                n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function () {
                    ...
                    I = [],
                    L = [],
                (x.qsa = ve.test(i.querySelectorAll)) && (r(function (e) {
                    e.innerHTML = "<select msallowclip=''><option selected=''></option></select>",
                    e.querySelectorAll("[msallowclip^='']").length && L.push("[*^$]=" + ne + "*(?:''|\"\")"),
                    e.querySelectorAll("[selected]").length || L.push("\\[" + ne + "*(?:value|" + ie + ")"),
                ...
                (x.matchesSelector = ve.test(z = R.matches || R.webkitMatchesSelector || R.mozMatchesSelector || R.oMatchesSelector || R.msMatchesSelector)) && r(function (e) {
                    ...
                    F = t || ve.test(R.contains) ? function (e, t) {
                    ...
                    V = t ? function (e, t) {
                            ...
                            return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1,
                                1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === B && F(B, e) ? -1 : t === i || t.ownerDocument === B && F(B, t) ? 1 : O ? te.call(O, e) - te.call(O, t) : 0 : 4 & n ? -1 : 1)
                        }
                        : function (e, t) {
                            if (e === t)
                                return E = !0,
                                    0;
                            var n, r = 0, s = e.parentNode, o = t.parentNode, l = [e], u = [t];
                            if (!s || !o)
                                return e === i ? -1 : t === i ? 1 : s ? -1 : o ? 1 : O ? te.call(O, e) - te.call(O, t) : 0;
                            if (s === o)
                                return a(e, t);
            ...
            t.matchesSelector = function (e, i) {
                if ((e.ownerDocument || e) !== A && M(e),
                        i = i.replace(pe, "='$1']"),
                        !(!x.matchesSelector || !N || I && I.test(i) || L && L.test(i)))
                    try {
                        var n = z.call(e, i);
            ...
            b = t.selectors = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function (e) {
                        var t, i = !e[6] && e[2];
                        return fe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : i && he.test(i) && (t = C(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t),
                            e[2] = i.slice(0, t)),
                            e.slice(0, 3))
                    }
                },
                filter: {
                    ...
                    CHILD: function (e, t, i, n, r) {
                        ...
                        return 1 === n && 0 === r ? function (e) {
                            ...
                            : function (t, i, l) {
                                var u, c, p, h, d, f, m = s !== a ? "nextSibling" : "previousSibling", g = t.parentNode,
                                    v = o && t.nodeName.toLowerCase(), _ = !l && !o;
                                if (g) {
                                    if (s) {
                                        for (; m;) {
                                            for (p = t; p = p[m];)
                                    ...
                                    } else if (_ && (u = (t[j] || (t[j] = {}))[e]) && u[0] === X)
                                        h = u[1];
                                    else
                                        for (; (p = ++d && p && p[m] || (h = d = 0) || f.pop()) && ((o ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++h || (_ && ((p[j] || (p[j] = {}))[e] = [X, h]),
                                        p !== t));)
                                            ;
                                    return h -= r,
                                    h === n || h % n === 0 && h / n >= 0
                    ...
                    PSEUDO: function (e, i) {
                        ...
                        return s[j] ? s(i) : s.length > 1 ? (r = [e, e, "", i],
                ...
                pseudos: {
                    not: n(function (e) {
                        ...
                        return r[j] ? n(function (e, t, i, n) {
                            for (var s, a = r(e, null, n, []), o = e.length; o--;)
                                (s = a[o]) && (e[o] = !(t[o] = s))
                        }) : function (e, n, s) {
                            return t[0] = e,
                                r(t, null, s, i),
        ...
        for (w in {
            ...
            b.pseudos[w] = l(w);
        return p.prototype = b.filters = b.pseudos,
            b.setFilters = new p,
            C = t.tokenize = function (e, i) {
                ...
                for (o = e,
                         l = [],
                         u = b.preFilter; o;) {
                    (!n || (r = ue.exec(o))) && (r && (o = o.slice(r[0].length) || o),
                        l.push(s = [])),
                        n = !1,
                    (r = ce.exec(o)) && (n = r.shift(),
                        s.push({
                            value: n,
                            type: r[0].replace(le, " ")
                        }),
                        o = o.slice(n.length));
                    for (a in b.filter)
                        !(r = fe[a].exec(o)) || u[a] && !(r = u[a](r)) || (n = r.shift(),
                            s.push({
                                value: n,
                                type: a,
                                matches: r
            ...
            k = t.select = function (e, t, i, n) {
                var r, s, a, o, l, u = "function" == typeof e && e, p = !n && C(e = u.selector || e);
                if (i = i || [],
                    1 === p.length) {
                    if (s = p[0] = p[0].slice(0),
                        s.length > 2 && "ID" === (a = s[0]).type && x.getById && 9 === t.nodeType && N && b.relative[s[1].type]) {
                        if (t = (b.find.ID(a.matches[0].replace(xe, be), t) || [])[0],
                                !t)
                            return i;
                        u && (t = t.parentNode),
                            e = e.slice(s.shift().value.length)
                    }
                    for (r = fe.needsContext.test(e) ? 0 : s.length; r-- && (a = s[r],
                        !b.relative[o = a.type]);)
                ...
                return (u || P(e, p))(n, t, !N, i, ye.test(e) && c(t.parentNode) || t),
                    i
            }
            ,
            x.sortStable = j.split("").sort(V).join("") === j,
    ...
    J.find = re,
        ...
        J.unique = re.uniqueSort,
        J.text = re.getText,
        J.isXMLDoc = re.isXML,
        J.contains = re.contains;
    ...
    J.filter = function (e, t, i) {
        var n = t[0];
        return i && (e = ":not(" + e + ")"),
            1 === t.length && 1 === n.nodeType ? J.find.matchesSelector(n, e) ? [n] : [] : J.find.matches(e, J.grep(t, function (e) {
                return 1 === e.nodeType
            }))
    }
        ,
    ...
    var le, ue = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ce = J.fn.init = function (e, t) {
            ...
            if (!e)
                return this;
            if ("string" == typeof e) {
                if (i = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : ue.exec(e),
                    !i || !i[1] && t)
                    return !t || t.jquery ? (t || le).find(e) : this.constructor(t).find(e);
                if (i[1]) {
                    if (t = t instanceof J ? t[0] : t,
                            J.merge(this, J.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : Z, !0)),
                        ae.test(i[1]) && J.isPlainObject(t))
                        for (i in t)
                            J.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                    return this
                }
            ...
            return e.nodeType ? (this.context = this[0] = e,
                this.length = 1,
                this) : J.isFunction(e) ? "undefined" != typeof le.ready ? le.ready(e) : e(J) : (void 0 !== e.selector && (this.selector = e.selector,
    ...
    J.Callbacks = function (e) {
        ...
        var t, i, n, r, a, o, l = [], u = !e.once && [], c = function (s) {
            for (t = e.memory && s,
                     i = !0,
                     o = r || 0,
                     r = 0,
        ...
        J.extend({
            ...
            when: function (e) {
                var t, i, n, r = 0, s = H.call(arguments), a = s.length,
                ...
                if (a > 1)
                    for (t = new Array(a),
                             i = new Array(a),
                             n = new Array(a); a > r; r++)
                        s[r] && J.isFunction(s[r].promise) ? s[r].promise().done(u(r, n, s)).fail(l.reject).progress(u(r, i, t)) : --o;
    ...
    J.fn.ready = function (e) {
        ...
        J.extend({
            ...
            ready: function (e) {
                ...
                e !== !0 && --J.readyWait > 0 || (me.resolveWith(Z, [J]),
                J.fn.triggerHandler && (J(Z).triggerHandler("ready"),
                    J(Z).off("ready"))))
            }
        }),
        J.ready.promise = function (t) {
            return me || (me = J.Deferred(),
        ...
        o.prototype = {
            ...
            access: function (e, t, i) {
                ...
                return void 0 === t || t && "string" == typeof t && void 0 === i ? (n = this.get(e, t),
                    void 0 !== n ? n : this.get(e, J.camelCase(t))) : (this.set(e, t, i),
                    void 0 !== i ? i : t)
            },
            remove: function (e, t) {
                ...
                if (void 0 === t)
                    ...
                    J.isArray(t) ? n = t.concat(t.map(J.camelCase)) : (r = J.camelCase(t),
                        t in a ? n = [t, r] : (n = r,
                            n = n in a ? [n] : n.match(de) || [])),
                        i = n.length;
                    for (; i--;)
                        delete a[n[i]]
                }
    ...
    J.extend({
        ...
        J.fn.extend({
            data: function (e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (r = _e.get(s),
                        1 === s.nodeType && !ve.get(s, "hasDataAttrs"))) {
                        for (i = a.length; i--;)
                            a[i] && (n = a[i].name,
                ...
                return "object" == typeof e ? this.each(function () {
                    ...
                    if (s && void 0 === t) {
                        ...
                        this.each(function () {
                            var i = _e.get(this, n);
                            _e.set(this, n, t),
                            -1 !== e.indexOf("-") && void 0 !== i && _e.set(this, e, t)
                        })
        ...
        J.extend({
            queue: function (e, t, i) {
                ...
                return e ? (t = (t || "fx") + "queue",
                    n = ve.get(e, t),
                i && (!n || J.isArray(i) ? n = ve.access(e, t, J.makeArray(i)) : n.push(i)),
                n || []) : void 0
            },
        ...
        J.fn.extend({
            queue: function (e, t) {
                ...
                return "string" != typeof e && (t = e,
                    e = "fx",
                    i--),
                    arguments.length < i ? J.queue(this[0], e) : void 0 === t ? this : this.each(function () {
                        var i = J.queue(this, e, t);
                        J._queueHooks(this, e),
                        "fx" === e && "inprogress" !== i[0] && J.dequeue(this, e)
                    })
            },
            dequeue: function (e) {
                return this.each(function () {
            ...
            promise: function (e, t) {
                var i, n = 1, r = J.Deferred(), s = this, a = this.length, o = function () {
                    --n || r.resolveWith(s, [s])
                };
                for ("string" != typeof e && (t = e,
                    e = void 0),
                         e = e || "fx"; a--;)
                    i = ve.get(s[a], e + "queueHooks"),
                    i && i.empty && (n++,
                        i.empty.add(o));
                return o(),
                    r.promise(t)
    ...
    J.event = {
        ...
        add: function (e, t, i, n, r) {
            ...
            if (g)
                for (i.handler && (s = i,
                    ...
                    (h = l[d]) || (h = l[d] = [],
                        h.delegateCount = 0,
                    p.setup && p.setup.call(e, n, f, a) !== !1 || e.addEventListener && e.addEventListener(d, a, !1)),
                ...
                for (t = (t || "").match(de) || [""],
                    ...
                    if (o = Oe.exec(t[u]) || [],
                        ...
                        for (p = J.event.special[d] || {},
                                 d = (n ? p.delegateType : p.bindType) || d,
                                 h = l[d] || [],
                                 o = o[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                                 a = s = h.length; s--;)
                            c = h[s],
                            !r && m !== c.origType || i && i.guid !== c.guid || o && !o.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (h.splice(s, 1),
                            c.selector && h.delegateCount--,
                            p.remove && p.remove.call(e, c));
                        a && !h.length && (p.teardown && p.teardown.call(e, f, g.handle) !== !1 || J.removeEvent(e, d, g.handle),
                            delete l[d])
                    } else
                        for (d in l)
                            J.event.remove(e, d + t[u], i, n, !0);
                J.isEmptyObject(l) && (delete g.handle,
                    ve.remove(e, "events"))
            }
        },
        trigger: function (t, i, n, r) {
            var s, a, o, l, u, c, p, h = [n || Z], d = U.call(t, "type") ? t.type : t,
                f = U.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = o = n = n || Z,
                3 !== n.nodeType && 8 !== n.nodeType && !De.test(d + J.event.triggered) && (d.indexOf(".") >= 0 && (f = d.split("."),
                    d = f.shift(),
                    f.sort()),
                    u = d.indexOf(":") < 0 && "on" + d,
                    ...
                    t.result = void 0,
                t.target || (t.target = n),
                    i = null == i ? [t] : J.makeArray(i, [t]),
                    p = J.event.special[d] || {},
                r || !p.trigger || p.trigger.apply(n, i) !== !1)) {
                if (!r && !p.noBubble && !J.isWindow(n)) {
                    for (l = p.delegateType || d,
                         De.test(l + d) || (a = a.parentNode); a; a = a.parentNode)
                        h.push(a),
                            o = a;
                ...
                for (s = 0; (a = h[s++]) && !t.isPropagationStopped();)
                    ...
                    c && c.apply(a, i),
                        c = u && a[u],
                    c && c.apply && J.acceptData(a) && (t.result = c.apply(a, i),
                    t.result === !1 && t.preventDefault());
                return t.type = d,
                r || t.isDefaultPrevented() || p._default && p._default.apply(h.pop(), i) !== !1 || !J.acceptData(n) || u && J.isFunction(n[d]) && !J.isWindow(n) && (o = n[u],
                o && (n[u] = null),
                    J.event.triggered = d,
                    n[d](),
        ...
        dispatch: function (e) {
            e = J.event.fix(e);
            var t, i, n, r, s, a = [], o = H.call(arguments), l = (ve.get(this, "events") || {})[e.type] || [],
                ...
                for (a = J.event.handlers.call(this, e, l),
                    ...
                    for (e.currentTarget = r.elem,
                        ...
                        (!e.namespace_re || e.namespace_re.test(s.namespace)) && (e.handleObj = s,
                            e.data = s.data,
                            n = ((J.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, o),
        ...
        mouseHooks: {
            ...
            filter: function (e, t) {
                ...
                return null == e.pageX && null != t.clientX && (i = e.target.ownerDocument || Z,
                    n = i.documentElement,
                    r = i.body,
        ...
        fix: function (e) {
            ...
            for (a || (this.fixHooks[r] = a = ke.test(r) ? this.mouseHooks : Pe.test(r) ? this.keyHooks : {}),
        ...
        simulate: function (e, t, i, n) {
            ...
            n ? J.event.trigger(r, null, t) : J.event.dispatch.call(t, r),
        ...
        J.each({
            ...
            J.event.special[e] = {
                ...
                handle: function (e) {
                    ...
                    return (!r || r !== n && !J.contains(n, r)) && (e.type = s.origType,
    ...
    Q.focusinBubbles || J.each({
        ...
        J.event.special[t] = {
            ...
            teardown: function () {
                var n = this.ownerDocument || this
                    , r = ve.access(n, t) - 1;
                r ? ve.access(n, t, r) : (n.removeEventListener(e, i, !0),
                    ve.remove(n, t))
            }
        }
    }),
            ...
            off: function (e, t, i) {
                ...
                if (e && e.preventDefault && e.handleObj)
                    return n = e.handleObj,
                        J(e.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace : n.origType, n.selector, n.handler),
                        this;
                if ("object" == typeof e) {
                    for (r in e)
                        this.off(r, t, e[r]);
    ...
    Fe.optgroup = Fe.option,
        ...
        J.extend({
            clone: function (e, t, i) {
                var n, r, s, a, o = e.cloneNode(!0), l = J.contains(e.ownerDocument, e);
            ...
            buildFragment: function (e, t, i, n) {
                ...
                for (c.textContent = "",
                    ...
                    if ((!n || -1 === J.inArray(r, n)) && (l = J.contains(r.ownerDocument, r),
                            s = v(c.appendChild(r), "script"),
                        l && m(s),
                            i))
                        for (u = 0; r = s[u++];)
                            Le.test(r.type || "") && i.push(r);
                return c
            },
            cleanData: function (e) {
                for (var t, i, n, r, s = J.event.special, a = 0; void 0 !== (i = e[a]); a++) {
                    if (J.acceptData(i) && (r = i[ve.expando],
                        r && (t = ve.cache[r]))) {
                        if (t.events)
                            for (n in t.events)
                                s[n] ? J.event.remove(i, n) : J.removeEvent(i, n, t.handle);
        ...
        J.fn.extend({
            ...
            remove: function (e, t) {
                for (var i, n = e ? J.filter(e, this) : this, r = 0; null != (i = n[r]); r++)
                    t || 1 !== i.nodeType || J.cleanData(v(i)),
                    i.parentNode && (t && J.contains(i.ownerDocument, i) && m(v(i, "script")),
            ...
            domManip: function (e, t) {
                e = $.apply([], e);
                var i, n, r, s, a, o, l = 0, u = this.length, c = this, p = u - 1, h = e[0], m = J.isFunction(h);
                if (m || u > 1 && "string" == typeof h && !Q.checkClone && Ne.test(h))
                    return this.each(function (i) {
                        var n = c.eq(i);
                        m && (e[0] = h.call(this, i, n.html())),
                            n.domManip(e, t)
                    });
                if (u && (i = J.buildFragment(e, this[0].ownerDocument, !1, this),
                        n = i.firstChild,
                    1 === i.childNodes.length && (i = n),
                        n)) {
                    for (r = J.map(v(i, "script"), d),
                             s = r.length; u > l; l++)
                        a = i,
                        l !== p && (a = J.clone(a, !0, !0),
                        s && J.merge(r, v(a, "script"))),
                            t.call(this[l], a, l);
                    if (s)
                        for (o = r[r.length - 1].ownerDocument,
                                 ...
                                 l = 0; s > l; l++)
                            a = r[l],
                            Le.test(a.type || "") && !ve.access(a, "globalEval") && J.contains(o, a) && (a.src ? J._evalUrl && J._evalUrl(a.src) : J.globalEval(a.textContent.replace(ze, "")))
                }
                return this
            }
        }),
        J.each({
            ...
            J.fn[e] = function (e) {
                for (var i, n = [], r = J(e), s = r.length - 1, a = 0; s >= a; a++)
    ...
    var je, Be = {}, Xe = /^margin/, qe = new RegExp("^(" + xe + ")(?!px)[a-z%]+$", "i"), He = function (e) {
    ...
    !function () {
        ...
        var i, n, r = Z.documentElement, s = Z.createElement("div"), a = Z.createElement("div");
    ...
    J.extend({
        ...
        style: function (e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = J.cssProps[o] || (J.cssProps[o] = T(l, o)),
                    a = J.cssHooks[t] || J.cssHooks[o],
                    void 0 === i ? a && "get" in a && void 0 !== (r = a.get(e, !1, n)) ? r : l[t] : (s = typeof i,
                    "string" === s && (r = Ve.exec(i)) && (i = (r[1] + 1) * r[2] + parseFloat(J.css(e, t)),
                        s = "number"),
                        void (null != i && i === i && ("number" !== s || J.cssNumber[o] || (i += "px"),
        ...
        css: function (e, t, i, n) {
            ...
            return t = J.cssProps[o] || (J.cssProps[o] = T(e.style, o)),
                a = J.cssHooks[t] || J.cssHooks[o],
        ...
        J.fx.step = {};
    var Qe, Ze, Ke = /^(?:toggle|show|hide)$/, Je = new RegExp("^(?:([+-])=|)(" + xe + ")([a-z%]*)$", "i"),
        et = /queueHooks$/, tt = [A], it = {
            "*": [function (e, t) {
                ...
                if (a && a[3] !== s) {
                    ...
                    do
                        o = o || ".5",
                            a /= o,
                            J.style(i.elem, e, a + s);
                    while (o !== (o = i.cur() / n) && 1 !== o && --l)
                }
                return r && (a = i.start = +a || +n || 0,
                    i.unit = s,
    ...
    J.Animation = J.extend(N, {
        ...
        J.fn.extend({
                ...
                t && e !== !1 && this.queue(e || "fx", []),
                    this.each(function () {
                        ...
                        if (r)
                            ...
                            for (r in a)
                                a[r] && a[r].stop && et.test(r) && n(a[r]);
                        for (r = s.length; r--;)
                            s[r].elem !== this || null != e && s[r].queue !== e || (s[r].anim.stop(i),
                                t = !1,
                                s.splice(r, 1));
            ...
            finish: function (e) {
                return e !== !1 && (e = e || "fx"),
                    this.each(function () {
                        var t, i = ve.get(this), n = i[e + "queue"], r = i[e + "queueHooks"], s = J.timers,
                            a = n ? n.length : 0;
                        for (i.finish = !0,
                                 J.queue(this, e, []),
    ...
    J.fn.extend({
        ...
        J.extend({
            attr: function (e, t, i) {
                ...
                if (e && 3 !== s && 8 !== s && 2 !== s)
                    return typeof e.getAttribute === Ce ? J.prop(e, t, i) : (1 === s && J.isXMLDoc(e) || (t = t.toLowerCase(),
                        n = J.attrHooks[t] || (J.expr.match.bool.test(t) ? rt : nt)),
                        void 0 === i ? n && "get" in n && null !== (r = n.get(e, t)) ? r : (r = J.find.attr(e, t),
                            null == r ? void 0 : r) : null !== i ? n && "set" in n && void 0 !== (r = n.set(e, i, t)) ? r : (e.setAttribute(t, i + ""),
                            i) : void J.removeAttr(e, t))
            },
            removeAttr: function (e, t) {
                var i, n, r = 0, s = t && t.match(de);
                if (s && 1 === e.nodeType)
                    for (; i = s[r++];)
                        n = J.propFix[i] || i,
                        J.expr.match.bool.test(i) && (e[n] = !1),
                            e.removeAttribute(i)
            },
            attrHooks: {
                type: {
        ...
        rt = {
            set: function (e, t, i) {
                return t === !1 ? J.removeAttr(e, i) : e.setAttribute(i, i),
                    i
            }
        },
    ...
    J.fn.extend({
        addClass: function (e) {
            var t, i, n, r, s, a, o = "string" == typeof e && e, l = 0, u = this.length;
            if (J.isFunction(e))
            ...
            if (o)
                for (t = (e || "").match(de) || []; u > l; l++)
                    if (i = this[l],
                            n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(ot, " ") : " ")) {
                        for (s = 0; r = t[s++];)
                            n.indexOf(" " + r + " ") < 0 && (n += r + " ");
                        a = J.trim(n),
        ...
        removeClass: function (e) {
            var t, i, n, r, s, a, o = 0 === arguments.length || "string" == typeof e && e, l = 0, u = this.length;
            if (J.isFunction(e))
                return this.each(function (t) {
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === i ? t ? this.addClass(e) : this.removeClass(e) : this.each(J.isFunction(e) ? function (i) {
                ...
                : function () {
                    if ("string" === i)
                        for (var t, n = 0, r = J(this), s = e.match(de) || []; t = s[n++];)
                            r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                    else
                        (i === Ce || "boolean" === i) && (this.className && ve.set(this, "__className__", this.className),
    ...
    J.fn.extend({
        val: function (e) {
            var t, i, n, r = this[0];
            return arguments.length ? (n = J.isFunction(e),
                this.each(function (i) {
                    var r;
                    1 === this.nodeType && (r = n ? e.call(this, i, J(this).val()) : e,
                ...
                })) : r ? (t = J.valHooks[r.type] || J.valHooks[r.nodeName.toLowerCase()],
        ...
        J.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function (e, t) {
                        for (var i, n, r = e.options, s = J.makeArray(t), a = r.length; a--;)
                            n = r[a],
    ...
    ;
    var pt, ht, dt = /#.*$/, ft = /([?&])_=[^&]*/, mt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        gt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, vt = /^(?:GET|HEAD)$/, _t = /^\/\//,
        yt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, wt = {}, xt = {}, bt = "*/".concat("*");
    try {
        ht = location.href
    } catch (Tt) {
            ...
            ajax: function (e, t) {
                function i(e, t, i, a) {
                    ...
                    i && (_ = F(p, x, i)),
                        ...
                        w && (J.etag[r] = w)),
                            204 === e || "HEAD" === p.type ? b = "nocontent" : 304 === e ? b = "notmodified" : (b = _.state,
                                c = _.data,
                                v = _.error,
                                l = !v)) : (v = b,
                        (e || !b) && (b = "error",
                        ...
                        x.status = e,
                        x.statusText = (t || b) + "",
                        l ? f.resolveWith(h, [c, b, x]) : f.rejectWith(h, [x, b, v]),
                        x.statusCode(g),
                        g = void 0,
                    u && d.trigger(l ? "ajaxSuccess" : "ajaxError", [x, p, l ? c : v]),
                        m.fireWith(h, [x, b]),
                    u && (d.trigger("ajaxComplete", [x, p]),
                ...
                "object" == typeof e && (t = e,
                    e = void 0),
                    t = t || {};
                var n, r, s, a, o, l, u, c, p = J.ajaxSetup({}, t), h = p.context || p,
                    d = p.context && (h.nodeType || h.jquery) ? J(h) : J.event, f = J.Deferred(),
                    m = J.Callbacks("once memory"), g = p.statusCode || {}, v = {}, _ = {}, y = 0, w = "canceled", x = {
                        readyState: 0,
                ...
                if (f.promise(x).complete = m.add,
                        x.success = x.done,
                        x.error = x.fail,
                        p.url = ((e || p.url || ht) + "").replace(dt, "").replace(_t, pt[1] + "//"),
                        p.type = t.method || t.type || p.method || p.type,
                        p.dataTypes = J.trim(p.dataType || "*").toLowerCase().match(de) || [""],
                    null == p.crossDomain && (l = yt.exec(p.url.toLowerCase()),
                        p.crossDomain = !(!l || l[1] === pt[1] && l[2] === pt[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (pt[3] || ("http:" === pt[1] ? "80" : "443")))),
                ...
                p.hasContent || (p.data && (r = p.url += (ct.test(r) ? "&" : "?") + p.data,
                    delete p.data),
                p.cache === !1 && (p.url = ft.test(r) ? r.replace(ft, "$1_=" + ut++) : r + (ct.test(r) ? "&" : "?") + "_=" + ut++)),
                p.ifModified && (J.lastModified[r] && x.setRequestHeader("If-Modified-Since", J.lastModified[r]),
                J.etag[r] && x.setRequestHeader("If-None-Match", J.etag[r])),
                ...
                if (p.beforeSend && (p.beforeSend.call(h, x, p) === !1 || 2 === y))
                    return x.abort();
                w = "abort";
                for (c in {
                    success: 1,
                ...
                if (n = I(xt, p, t, x)) {
                    ...
                    p.async && p.timeout > 0 && (o = setTimeout(function () {
                        x.abort("timeout")
                    }, p.timeout));
                    try {
                        y = 1,
    ...
    e.ActiveXObject && J(e).on("unload", function () {
        ...
        Q.cors = !!At && "withCredentials" in At,
        Q.ajax = At = !!At,
                    ...
                    t = function (e) {
                        return function () {
                            t && (delete Et[a],
                                ...
                                "abort" === e ? s.abort() : "error" === e ? n(s.status, s.statusText) : n(Mt[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                                    text: s.responseText
    ...
    J.ajaxSetup({
        ...
        J.ajaxPrefilter("json jsonp", function (t, i, n) {
            var r, s, a,
                o = t.jsonp !== !1 && (Nt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Nt.test(t.data) && "data");
            return o || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = J.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                o ? t[o] = t[o].replace(Nt, "$1" + r) : t.jsonp !== !1 && (t.url += (ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
        ...
        J.parseHTML = function (e, t, i) {
            ...
            var n = ae.exec(e)
                , r = !i && [];
            return n ? [t.createElement(n[1])] : (n = J.buildFragment([e], t, r),
    ...
    J.fn.load = function (e, t, i) {
        ...
        a.length > 0 && J.ajax({
            ...
            s = arguments,
                a.html(n ? J("<div>").append(J.parseHTML(e)).find(n) : e)
    ...
    J.offset = {
        setOffset: function (e, t, i) {
            var n, r, s, a, o, l, u, c = J.css(e, "position"), p = J(e), h = {};
        ...
        J.fn.extend({
            offset: function (e) {
                ...
                return s ? (t = s.documentElement,
                    J.contains(t, n) ? (typeof n.getBoundingClientRect !== Ce && (r = n.getBoundingClientRect()),
                        i = X(s),
                        {
            ...
            offsetParent: function () {
                return this.map(function () {
                    for (var e = this.offsetParent || It; e && !J.nodeName(e, "html") && "static" === J.css(e, "position");)
                        e = e.offsetParent;
                    return e || It
                })
            }
        ...
        J.each(["top", "left"], function (e, t) {
            J.cssHooks[t] = b(Q.pixelPosition, function (e, i) {
                return i ? (i = x(e, t),
                    qe.test(i) ? J(e).position()[t] + "px" : i) : void 0
            })
        }),
        J.each({
            Height: "height",
                ...
                J.fn[n] = function (n, r) {
                    ...
                    return ge(this, function (t, i, n) {
                        ...
                        return J.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement,
                            Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === n ? J.css(t, i, a) : J.style(t, i, n, a)
                    }, t, s ? n : void 0, s, null)
                }
            })
        }),
    ...
    return J.noConflict = function (t) {
        return e.$ === J && (e.$ = Ft),
        t && e.jQuery === J && (e.jQuery = zt),
            J
    }
        ,
    typeof t === Ce && (e.jQuery = e.$ = J),
        J
}),
    function (e) {
        ...
        function i(t, i) {
            function D(t) {
                if (!(ue() || e(t.target).closest(i.excludedElements, $e).length > 0)) {
                    var n, r = t.originalEvent ? t.originalEvent : t, s = S ? r.touches[0] : r;
                    return We = w,
                        S ? Ve = r.touches.length : t.preventDefault(),
                        Le = 0,
                        Ie = null,
                        qe = null,
                        ze = 0,
                        ...
                        He = ve(),
                        oe(),
                        !S || Ve === i.fingers || i.fingers === _ || H() ? (pe(0, s),
                            Ge = Pe(),
                        2 == Ve && (pe(1, r.touches[1]),
                            Fe = je = we(Ye[0].start, Ye[1].start)),
                        (i.swipeStatus || i.pinchStatus) && (n = L(r, We))) : n = !1,
                        n === !1 ? (We = T,
                            L(r, We),
                            n) : (i.hold && (et = setTimeout(e.proxy(function () {
                            $e.trigger("hold", [r.target]),
                            i.hold && (n = i.hold.call($e, r, r.target))
            ...
            function O(e) {
                ...
                if (We !== b && We !== T && !le()) {
                    var n, r = S ? t.touches[0] : t, s = he(r);
                    if (Ue = Pe(),
                        S && (Ve = t.touches.length),
                        i.hold && clearTimeout(et),
                            We = x,
                        2 == Ve && (0 == Fe ? (pe(1, t.touches[1]),
                            Fe = je = we(Ye[0].start, Ye[1].start)) : (he(t.touches[1]),
                            je = we(Ye[0].end, Ye[1].end),
                            qe = be(Ye[0].end, Ye[1].end)),
                            Be = xe(Fe, je),
                            Xe = Math.abs(Fe - je)),
                        Ve === i.fingers || i.fingers === _ || !S || H()) {
                        if (Ie = Ce(s.start, s.end),
                                X(e, Ie),
                                Le = Te(s.start, s.end),
                                ze = ye(),
                                me(Ie, Le),
                            (i.swipeStatus || i.pinchStatus) && (n = L(t, We)),
                            ...
                            !i.triggerOnTouchEnd && a ? We = N(x) : i.triggerOnTouchLeave && !a && (We = N(b)),
                            We != T && We != b || L(t, We)
                        }
                    } else
                        We = T,
            ...
            function E(e) {
                ...
                return S && t.touches.length > 0 ? (ae(),
                    ...
                    ze = ye(),
                    F() || !z() ? (We = T,
                        L(t, We)) : i.triggerOnTouchEnd || 0 == i.triggerOnTouchEnd && We === x ? (e.preventDefault(),
                        We = b,
                        L(t, We)) : !i.triggerOnTouchEnd && Q() ? (We = b,
                        I(t, We, d)) : We === x && (We = T,
                        L(t, We)),
                    ce(!1),
                    null)
            ...
            function N(e) {
                var t = e
                    ...
                    , r = z()
                    , s = F();
                return !n || s ? t = T : !r || e != x || i.triggerOnTouchEnd && !i.triggerOnTouchLeave ? !r && e == b && i.triggerOnTouchLeave && (t = T) : t = b,
                    t
            }

            function L(e, t) {
                var i = void 0;
                return Y() || V() ? i = I(e, t, p) : ($() || H()) && i !== !1 && (i = I(e, t, h)),
                    re() && i !== !1 ? i = I(e, t, f) : se() && i !== !1 ? i = I(e, t, m) : ne() && i !== !1 && (i = I(e, t, d)),
                t === T && M(e),
                t === b && (S ? 0 == e.touches.length && M(e) : M(e)),
                    i
            }
            ...
            function I(t, u, c) {
                var g = void 0;
                if (c == p) {
                    if ($e.trigger("swipeStatus", [u, Ie || null, Le || 0, ze || 0, Ve, Ye]),
                        i.swipeStatus && (g = i.swipeStatus.call($e, t, u, Ie || null, Le || 0, ze || 0, Ve, Ye),
                        g === !1))
                        return !1;
                    if (u == b && W()) {
                        if ($e.trigger("swipe", [Ie, Le, ze, Ve, Ye]),
                            i.swipe && (g = i.swipe.call($e, t, Ie, Le, ze, Ve, Ye),
                            g === !1))
                            return !1;
                        switch (Ie) {
                            case n:
                                $e.trigger("swipeLeft", [Ie, Le, ze, Ve, Ye]),
                                i.swipeLeft && (g = i.swipeLeft.call($e, t, Ie, Le, ze, Ve, Ye));
                                break;
                            case r:
                                $e.trigger("swipeRight", [Ie, Le, ze, Ve, Ye]),
                                i.swipeRight && (g = i.swipeRight.call($e, t, Ie, Le, ze, Ve, Ye));
                                break;
                            case s:
                                $e.trigger("swipeUp", [Ie, Le, ze, Ve, Ye]),
                                i.swipeUp && (g = i.swipeUp.call($e, t, Ie, Le, ze, Ve, Ye));
                                break;
                            case a:
                                $e.trigger("swipeDown", [Ie, Le, ze, Ve, Ye]),
                                i.swipeDown && (g = i.swipeDown.call($e, t, Ie, Le, ze, Ve, Ye))
                        }
                    }
                }
                if (c == h) {
                    if ($e.trigger("pinchStatus", [u, qe || null, Xe || 0, ze || 0, Ve, Be, Ye]),
                        i.pinchStatus && (g = i.pinchStatus.call($e, t, u, qe || null, Xe || 0, ze || 0, Ve, Be, Ye),
                        g === !1))
                        return !1;
                    if (u == b && q())
                        switch (qe) {
                            case o:
                                $e.trigger("pinchIn", [qe || null, Xe || 0, ze || 0, Ve, Be, Ye]),
                                i.pinchIn && (g = i.pinchIn.call($e, t, qe || null, Xe || 0, ze || 0, Ve, Be, Ye));
                                break;
                            case l:
                                $e.trigger("pinchOut", [qe || null, Xe || 0, ze || 0, Ve, Be, Ye]),
                                i.pinchOut && (g = i.pinchOut.call($e, t, qe || null, Xe || 0, ze || 0, Ve, Be, Ye))
                        }
                }
                return c == d ? u !== T && u !== b || (clearTimeout(Je),
                    clearTimeout(et),
                    Z() && !ee() ? (Ke = Pe(),
                        Je = setTimeout(e.proxy(function () {
                            Ke = null,
                                $e.trigger("tap", [t.target]),
                            i.tap && (g = i.tap.call($e, t, t.target))
                        }, this), i.doubleTapThreshold)) : (Ke = null,
                        $e.trigger("tap", [t.target]),
                    i.tap && (g = i.tap.call($e, t, t.target)))) : c == f ? u !== T && u !== b || (clearTimeout(Je),
                    Ke = null,
                    $e.trigger("doubletap", [t.target]),
                i.doubleTap && (g = i.doubleTap.call($e, t, t.target))) : c == m && (u !== T && u !== b || (clearTimeout(Je),
                    Ke = null,
                    $e.trigger("longtap", [t.target]),
                i.longTap && (g = i.longTap.call($e, t, t.target)))),
                    g
            }

            function z() {
                var e = !0;
                return null !== i.threshold && (e = Le >= i.threshold),
                    e
            }

            function F() {
                var e = !1;
                return null !== i.cancelThreshold && null !== Ie && (e = ge(Ie) - Le >= i.cancelThreshold),
                    e
            }
            ...
            function ce(e) {
                e === !0 ? ($e.bind(Me, O),
                    $e.bind(Ae, E),
                Re && $e.bind(Re, A)) : ($e.unbind(Me, O, !1),
                    $e.unbind(Ae, E, !1),
                Re && $e.unbind(Re, A, !1)),
                    $e.data(k + "_intouch", e === !0)
            }

            function pe(e, t) {
                var i = void 0 !== t.identifier ? t.identifier : 0;
                return Ye[e].identifier = i,
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (e, t, i) {
        ...
        r.version = "1.16.1",
            ...
            u.updateTo = function (e, t) {
                var n, r = this.ratio, s = this.vars.immediateRender || e.immediateRender;
            ...
            u.render = function (e, t, i) {
                ...
                var n, r, o, l, u, p, h, d, f = this._dirty ? this.totalDuration() : this._totalDuration,
                    m = this._time, g = this._totalTime, v = this._cycle, _ = this._duration, y = this._rawPrevTime;
                if (e >= f ? (this._totalTime = f,
                    ...
                    y > s && (r = "onReverseComplete")),
                        this._rawPrevTime = d = !t || e || y === e ? e : s)) : 1e-7 > e ? (this._totalTime = this._time = this._cycle = 0,
                        this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
                    (0 !== g || 0 === _ && y > 0) && (r = "onReverseComplete",
                        n = this._reversed),
                    0 > e && (this._active = !1,
                    0 === _ && (this._initted || !this.vars.lazy || i) && (y >= 0 && (i = !0),
                        this._rawPrevTime = d = !t || e || y === e ? e : s)),
                    ...
                    this._yoyo && 0 !== (1 & this._cycle) && (this._time = _ - this._time),
                        ...
                        3 === p && (u *= 2),
                            ...
                            this.ratio = 1 === p ? 1 - u : 2 === p ? u : .5 > this._time / _ ? u / 2 : 1 - u / 2) : this.ratio = this._ease.getRatio(this._time / _)),
                    m === this._time && !i && v === this._cycle)
                    return void (g !== this._totalTime && this._onUpdate && (t || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || c)));
                if (!this._initted) {
                    if (this._init(),
                ...
                for (this._lazy !== !1 && (this._lazy = !1),
                     ...
                     this.vars.onStart && (0 !== this._totalTime || 0 === _) && (t || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || c))),
                         o = this._firstPT; o;)
                    o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s,
                        o = o._next;
                this._onUpdate && (0 > e && this._startAt && this._startTime && this._startAt.render(e, t, i),
                t || (this._totalTime !== g || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || c)),
                this._cycle !== v && (t || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || c)),
                r && (!this._gc || i) && (0 > e && this._startAt && !this._onUpdate && this._startTime && this._startAt.render(e, t, i),
                n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                    this._active = !1),
                !t && this.vars[r] && this.vars[r].apply(this.vars[r + "Scope"] || this, this.vars[r + "Params"] || c),
                0 === _ && this._rawPrevTime === s && d !== s && (this._rawPrevTime = 0))
            }
            ,
            r.to = function (e, t, i) {
                return new r(e, t, i)
            ...
            r.staggerTo = r.allTo = function (e, t, s, a, u, p, h) {
                a = a || 0;
                var d, f, m, g, v = s.delay || 0, _ = [], y = function () {
                    s.onComplete && s.onComplete.apply(s.onCompleteScope || this, arguments),
                        u.apply(h || this, p || c)
                };
                for (l(e) || ("string" == typeof e && (e = i.selector(e) || e),
                o(e) && (e = n(e))),
                         e = e || [],
                     0 > a && (e = n(e),
                         e.reverse(),
        ...
        ;
        var p = function (e, t) {
                for (var n = [], r = 0, s = e._first; s;)
                    s instanceof i ? n[r++] = s : (t && (n[r++] = s),
                        n = n.concat(p(s, t)),
                        r = n.length),
                        s = s._next;
                return n
        ...
        r.killAll = function (e, i, n, r) {
            null == i && (i = !0),
            null == n && (n = !0);
            var s, a, o, l = h(0 != r), u = l.length, c = i && n && r;
            for (o = 0; u > o; o++)
                a = l[o],
                (c || a instanceof t || (s = a.target === a.vars.onComplete) && n || i && !s) && (e ? a.totalTime(a._reversed ? 0 : a.totalDuration()) : a._enabled(!1, !1))
        }
            ,
                ...
                if (null != e) {
                    ...
                    if ("string" == typeof e && (e = i.selector(e) || e),
                        o(e) && (e = n(e)),
                            l(e))
                        for (p = e.length; --p > -1;)
                            r.killChildTweensOf(e[p], t);
                    else {
                        s = [];
                        for (c in d)
                            for (u = d[c].target.parentNode; u;)
                                u === e && (s = s.concat(d[c].tweens)),
                                    u = u.parentNode;
                        for (h = s.length,
                                 p = 0; h > p; p++)
        ...
        var d = function (e, i, n, r) {
            i = i !== !1,
                n = n !== !1,
                r = r !== !1;
            for (var s, a, o = h(r), l = i && n && r, u = o.length; --u > -1;)
                a = o[u],
                (l || a instanceof t || (s = a.target === a.vars.onComplete) && n || i && !s) && a.paused(e)
        };
        ...
        _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (e, t, i) {
            var n = function (e) {
                ...
                var s, a = e._timeline, o = a._totalTime, l = e._startTime,
                    u = 0 > e._rawPrevTime || 0 === e._rawPrevTime && a._reversed, c = u ? 0 : r, h = u ? r : 0;
                if (t || !this._forcingPlayhead) {
                    for (a.pause(l),
                             s = e._prev; s && s._startTime === l;)
                        s._rawPrevTime = h,
                            s = s._prev;
                    for (s = e._next; s && s._startTime === l;)
                        s._rawPrevTime = c,
                            s = s._next;
                    t && t.apply(n || a, i || p),
            ...
            return n.version = "1.16.1",
                ...
                n.exportRoot = function (e, t) {
                    ...
                    var r, s, a = new n(e), o = a._timeline;
                    for (null == t && (t = !0),
                             o._remove(a, !0),
                             a._startTime = 0,
                             ...
                             r = o._first; r;)
                        s = r._next,
                        t && r instanceof i && r.target === r.vars.onComplete || a.add(r, r._startTime - r._delay),
                            r = s;
                    return o.add(a, 0),
                        a
                }
                ...
                g._parseTimeOrLabel = function (t, i, n, r) {
                    ...
                    if (i = i || 0,
                        ...
                        i = parseInt(t.charAt(s - 1) + "1", 10) * Number(t.substr(s + 1)),
                            t = s > 1 ? this._parseTimeOrLabel(t.substr(0, s - 1), 0, n) : this.duration()
                    }
                    return Number(t) + i
                }
                ,
                ...
                g.render = function (e, t, i) {
                    ...
                    var n, s, a, o, l, h = this._dirty ? this.totalDuration() : this._totalDuration, d = this._time,
                    ...
                    if (e >= h)
                        ...
                        0 === this._duration && (0 === e || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== e && this._first && (l = !0,
                        this._rawPrevTime > r && (o = "onReverseComplete"))),
                            this._rawPrevTime = this._duration || !t || e || this._rawPrevTime === e ? e : r,
                            e = h + 1e-4;
                    else if (1e-7 > e)
                        if (this._totalTime = this._time = 0,
                            (0 !== d || 0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || 0 > e && this._rawPrevTime >= 0)) && (o = "onReverseComplete",
                                s = this._reversed),
                            0 > e)
                            this._active = !1,
                    ...
                    if (this._time !== d && this._first || i || l) {
                        if (this._initted || (this._initted = !0),
                            this._active || !this._paused && this._time !== d && e > 0 && (this._active = !0),
                            0 === d && this.vars.onStart && 0 !== this._time && (t || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || p)),
                            this._time >= d)
                            for (n = this._first; n && (a = n._next,
                            !this._paused || g);)
                                (n._active || n._startTime <= this._time && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)),
                                    n = a;
                        else
                            for (n = this._last; n && (a = n._prev,
                            !this._paused || g);)
                                (n._active || d >= n._startTime && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)),
                                    n = a;
                        this._onUpdate && (t || (u.length && c(),
                            this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || p))),
                        o && (this._gc || (f === this._startTime || m !== this._timeScale) && (0 === this._time || h >= this.totalDuration()) && (s && (u.length && c(),
                        this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                            this._active = !1),
                        !t && this.vars[o] && this.vars[o].apply(this.vars[o + "Scope"] || this, this.vars[o + "Params"] || p)))
                    }
                }
                ,
                ...
                g.getChildren = function (e, t, n, r) {
                    ...
                    for (var s = [], a = this._first, o = 0; a;)
                        r > a._startTime || (a instanceof i ? t !== !1 && (s[o++] = a) : (n !== !1 && (s[o++] = a),
                        e !== !1 && (s = s.concat(a.getChildren(!0, t, n)),
                            o = s.length))),
                            a = a._next;
                    return s
                }
                ...
                g.getTweensOf = function (e, t) {
                    ...
                    for (s && this._enabled(!0, !0),
                             n = i.getTweensOf(e),
                             r = n.length; --r > -1;)
                        (n[r].timeline === this || t && this._contains(n[r])) && (a[o++] = n[r]);
            ...
            return c.constructor = n,
                ...
                c.render = function (e, t, i) {
                    ...
                    var n, a, u, c, p, h, d = this._dirty ? this.totalDuration() : this._totalDuration,
                        ...
                        _ = this._timeScale, y = this._rawPrevTime, w = this._paused, x = this._cycle;
                    if (e >= d)
                        ...
                        0 === this._duration && (0 === e || 0 > y || y === r) && y !== e && this._first && (p = !0,
                        y > r && (c = "onReverseComplete"))),
                            this._rawPrevTime = this._duration || !t || e || this._rawPrevTime === e ? e : r,
                            this._yoyo && 0 !== (1 & this._cycle) ? this._time = e = 0 : (this._time = f,
                                e = f + 1e-4);
                    else if (1e-7 > e)
                        if (this._locked || (this._totalTime = this._cycle = 0),
                                this._time = 0,
                            (0 !== m || 0 === f && y !== r && (y > 0 || 0 > e && y >= 0) && !this._locked) && (c = "onReverseComplete",
                                a = this._reversed),
                            0 > e)
                            this._active = !1,
                                this._timeline.autoRemoveChildren && this._reversed ? (p = a = !0,
                                    c = "onReverseComplete") : y >= 0 && this._first && (p = !0),
                                this._rawPrevTime = e;
                        else {
                            if (this._rawPrevTime = f || !t || e || this._rawPrevTime === e ? e : r,
                                0 === e && a)
                                for (n = this._first; n && 0 === n._startTime;)
                                    n._duration || (a = !1),
                                        n = n._next;
                        ...
                        0 !== this._repeat && (h = f + this._repeatDelay,
                        ...
                        this._yoyo && 0 !== (1 & this._cycle) && (this._time = f - this._time),
                            this._time > f ? (this._time = f,
                                e = f + 1e-4) : 0 > this._time ? this._time = e = 0 : e = this._time));
                    if (this._cycle !== x && !this._locked) {
                        ...
                        if (this._totalTime = x * f,
                                x > this._cycle ? b = !b : this._totalTime += f,
                                this._time = m,
                                ...
                                m = b ? 0 : f,
                                this.render(m, t, 0 === f),
                            t || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || s),
                            T && (m = b ? f + 1e-4 : -1e-4,
                                this.render(m, !0, !1)),
                                this._locked = !1,
                            this._paused && !w)
                    ...
                    if (!(this._time !== m && this._first || i || p))
                        return void (g !== this._totalTime && this._onUpdate && (t || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s)));
                    if (this._initted || (this._initted = !0),
                        this._active || !this._paused && this._totalTime !== g && e > 0 && (this._active = !0),
                        0 === g && this.vars.onStart && 0 !== this._totalTime && (t || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || s)),
                        this._time >= m)
                        ...
                        !this._paused || w);)
                            (n._active || m >= n._startTime && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)),
                                n = u;
                    this._onUpdate && (t || (o.length && l(),
                        this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s))),
                    c && (this._locked || this._gc || (v === this._startTime || _ !== this._timeScale) && (0 === this._time || d >= this.totalDuration()) && (a && (o.length && l(),
                    this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                        this._active = !1),
                    !t && this.vars[c] && this.vars[c].apply(this.vars[c + "Scope"] || this, this.vars[c + "Params"] || s)))
                }
                ,
        ...
        function () {
            var e = 180 / Math.PI
                ...
                , u = function (e, r, s, a, o) {
                    var u, c, p, h, d, f, m, g, v, _, y, w, x, b = e.length - 1, T = 0, S = e[0].a;
                    for (u = 0; b > u; u++)
                        d = e[T],
                            c = d.a,
                            p = d.d,
                            ...
                            o ? (y = t[u],
                                w = i[u],
                                x = .25 * (w + y) * r / (a ? .5 : n[u] || .5),
                                f = p - (p - c) * (a ? .5 * r : 0 !== y ? x / y : 0),
                                m = p + (h - p) * (a ? .5 * r : 0 !== w ? x / w : 0),
                                g = p - (f + ((m - f) * (3 * y / (y + w) + .5) / 4 || 0))) : (f = p - .5 * (p - c) * r,
                                m = p + .5 * (h - p) * r,
                                g = p - (f + m) / 2),
                            f += g,
                            m += g,
                ...
                , c = function (e, n, r, s) {
                    ...
                    if (s)
                        for (e = [s].concat(e),
                                 l = e.length; --l > -1;)
                            "string" == typeof (h = e[l][n]) && "=" === h.charAt(1) && (e[l][n] = s[n] + Number(h.charAt(0) + h.substr(2)));
                    if (o = e.length - 2,
                        0 > o)
                        return d[0] = new a(e[0][n], 0, 0, e[-1 > o ? 0 : 1][n]),
                            d;
                    for (l = 0; o > l; l++)
                        u = e[l][n],
                            c = e[l + 1][n],
                        ...
                        r && (p = e[l + 2][n],
                            t[l] = (t[l] || 0) + (c - u) * (c - u),
                            i[l] = (i[l] || 0) + (p - c) * (p - c));
                    return d[l] = new a(e[l][n], 0, 0, e[l + 1][n]),
                        d
                }
                , p = function (e, s, a, l, p, h) {
                    var d, f, m, g, v, _, y, w, x = {}, b = [], T = h || e[0];
                    p = "string" == typeof p ? "," + p + "," : o,
                    null == s && (s = 1);
                    for (f in e[0])
                        b.push(f);
                    if (e.length > 1) {
                ...
                , h = function (e, t, i) {
                    t = t || "soft";
                    var n, r, s, o, l, u, c, p, h, d, f, m = {}, g = "cubic" === t ? 3 : 2, v = "soft" === t, _ = [];
                    if (v && i && (e = [i].concat(e)),
                        null == e || g + 1 > e.length)
                    ...
                    for (u = _.length; --u > -1;) {
                        for (h = _[u],
                                 ...
                                 p = e.length,
                                 c = 0; p > c; c++)
                            n = null == i ? e[c][h] : "string" == typeof (f = e[c][h]) && "=" === f.charAt(1) ? i[h] + Number(f.charAt(0) + f.substr(2)) : Number(f),
                            v && c > 1 && p - 1 > c && (l[d++] = (n + l[d - 2]) / 2),
                                l[d++] = n;
                        for (p = d - g + 1,
                                 d = 0,
                                 c = 0; p > c; c += g)
                            n = l[c],
                                ...
                                s = l[c + 2],
                                o = 2 === g ? 0 : l[c + 3],
                                l[d++] = f = 3 === g ? new a(n, r, s, o) : new a(n, (2 * r + n) / 3, (2 * r + s) / 3, s);
                        l.length = d
                    }
                    return m
                }
                , d = function (e, t, i) {
                    for (var n, r, s, a, o, l, u, c, p, h, d, f = 1 / i, m = e.length; --m > -1;)
                        for (h = e[m],
                            ...
                            u = f * c,
                                p = 1 - u,
                                n = r - (r = (u * u * a + 3 * p * (u * o + p * l)) * u),
                                d = m * i + c - 1,
                                t[d] = (t[d] || 0) + n * n
                }
                , f = function (e, t) {
                    t = t >> 0 || 6;
                    var i, n, r, s, a = [], o = [], l = 0, u = 0, c = t - 1, p = [], h = [];
                    for (i in e)
                        d(e[i], a, t);
                    for (r = a.length,
                             n = 0; r > n; n++)
                ...
                , m = _gsScope._gsDefine.plugin({
                    ...
                    init: function (e, t, i) {
                        ...
                        var n, r, s, a, o, l = t.values || [], u = {}, c = l[0], d = t.autoRotate || i.vars.orientToBezier;
                        ...
                        for (s = this._props.length; --s > -1;)
                            ...
                            o || u[n] !== l[0][n] && (o = u);
                        if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? p(l, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, o) : h(l, t.type, u),
                    ...
                    set: function (t) {
                        var i, n, r, s, a, o, l, u, c, p, h = this._segCount, d = this._func, f = this._target,
                        ...
                        if (this._autoRotate) {
                            ...
                            for (r = T.length; --r > -1;)
                                ...
                                a && g && (a = a[i],
                                    ...
                                    _ += (w - _) * o,
                                    w += (g.c + (g.d - g.c) * o - w) * o,
                                    l = m ? Math.atan2(w - _, y - v) * b + x : this._initialRotations[r],
                                    d[s] ? f[s](l) : f[s] = l)
                        }
                    }
                })
                        ...
                        t._registerComplexSpecialProp("bezier", {
                            parser: function (e, t, s, a, o, l) {
                                t instanceof Array && (t = {
                                    ...
                                    l = new m;
                                var u, c, p, h = t.values, d = h.length - 1, f = [], g = {};
                                if (0 > d)
                                    return o;
                                for (u = 0; d >= u; u++)
                                    p = i(e, h[u], a, o, l, d !== u),
                                ...
                                for (c in t)
                                    g[c] = t[c];
                                return g.values = f,
                                    o = new r(e, "bezier", 0, 0, p.pt, 2),
                                    o.data = p,
                                    o.plugin = l,
                                    o.setRatio = n,
                                0 === g.autoRotate && (g.autoRotate = !0),
                                !g.autoRotate || g.autoRotate instanceof Array || (u = g.autoRotate === !0 ? 0 : Number(g.autoRotate),
                                    g.autoRotate = null != p.end.left ? [["left", "top", "rotation", u, !1]] : null != p.end.x && [["x", "y", "rotation", u, !1]]),
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (e, t) {
            ...
            var c, p, h, d, f, m, g = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                ...
                w = /(?:\d|\-|\+|=|#|\.)*/g, x = /opacity *= *([^)]*)/i, b = /opacity:([^;]*)/i,
                T = /alpha\(opacity *=.+?\)/i, S = /^(rgb|hsl)/, C = /([A-Z])/g, P = /-([a-z])/gi,
                k = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, D = function (e, t) {
                    return t.toUpperCase()
                }, O = /(?:Left|Right|Width)/i, E = /(M11|M12|M21|M22)=[\d\-\.e]+/gi,
                M = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, A = /,(?=[^\)]*(?:\(|$))/gi,
                R = Math.PI / 180, N = 180 / Math.PI, L = {}, I = document, z = function (e) {
                    return I.createElementNS ? I.createElementNS("http://www.w3.org/1999/xhtml", e) : I.createElement(e)
                }, F = z("div"), j = z("img"), B = a._internals = {
                    _specialProps: l
                }, X = navigator.userAgent, q = function () {
                    var e = X.indexOf("Android")
                        , t = z("a");
                    return h = -1 !== X.indexOf("Safari") && -1 === X.indexOf("Chrome") && (-1 === e || Number(X.substr(e + 8, 1)) > 3),
                        f = h && 6 > Number(X.substr(X.indexOf("Version/") + 8, 1)),
                ...
                , U = a.getStyle = function (e, t, i, n, r) {
                    var s;
                    return q || "opacity" !== t ? (!n && e.style[t] ? s = e.style[t] : (i = i || G(e)) ? s = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(C, "-$1").toLowerCase()) : e.currentStyle && (s = e.currentStyle[t]),
                        null == r || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : r) : H(e)
                }
                , Q = B.convertToPixels = function (e, i, n, r, s) {
                    ...
                    if ("auto" === r || !n)
                        return 0;
                    var o, l, u, c = O.test(i), p = e, h = F.style, d = 0 > n;
                    if (d && (n = -n),
                        "%" === r && -1 !== i.indexOf("border"))
                        o = n / 100 * (c ? e.clientWidth : e.clientHeight);
                    else {
                        if (h.cssText = "border:0 solid red;position:" + U(e, "position") + ";line-height:0;",
                            "%" !== r && p.appendChild)
                            h[c ? "borderLeftWidth" : "borderTopWidth"] = n + r;
                        else {
                            if (p = e.parentNode || I.body,
                                    l = p._gsCache,
                                    u = t.ticker.frame,
                                l && c && l.time === u)
                        ...
                        p.appendChild(F),
                            o = parseFloat(F[c ? "offsetWidth" : "offsetHeight"]),
                            p.removeChild(F),
                        c && "%" === r && a.cacheWidths !== !1 && (l = p._gsCache = p._gsCache || {},
                            l.time = u,
                            l.width = 100 * (o / n)),
                        0 !== o || s || (o = Q(e, i, n, r, !0))
                    }
                ...
                , K = function (e, t) {
                    ...
                    if (t = t || G(e, null))
                        if (i = t.length)
                            for (; --i > -1;)
                                r = t[i],
                                (-1 === r.indexOf("-transform") || Te === r) && (s[r.replace(P, D)] = t.getPropertyValue(r));
                        else
                            for (i in t)
                                (-1 === i.indexOf("Transform") || be === i) && (s[i] = t[i]);
                    else if (t = e.currentStyle || e.style)
                        for (i in t)
                            "string" == typeof i && void 0 === s[i] && (s[i.replace(P, D)] = t[i]);
                    return q || (s.opacity = H(e)),
                        n = Ae(e, t, !1),
                    ...
                    for (a in i)
                        "cssText" !== a && "length" !== a && isNaN(a) && (t[a] !== (s = i[a]) || r && r[a]) && -1 === a.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[a] = "auto" !== s || "left" !== a && "top" !== a ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof t[a] || "" === t[a].replace(y, "") ? s : 0 : Z(e, a),
                        void 0 !== u[a] && (o = new de(u, a, u[a], o)));
                    if (n)
                        for (a in n)
                            "className" !== a && (l[a] = n[a]);
                    return {
                    ...
                    var n = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight)
                        , r = ee[t]
                        , s = r.length;
                    for (i = i || G(e, null); --s > -1;)
                        n -= parseFloat(U(e, "padding" + r[s], i, !0)) || 0,
                            n -= parseFloat(U(e, "border" + r[s] + "Width", i, !0)) || 0;
                    return n
                }, ne = function (e, t) {
                    ...
                    var t, i, n, r, s, a;
                    return e && "" !== e ? "number" == typeof e ? [e >> 16, 255 & e >> 8, 255 & e] : ("," === e.charAt(e.length - 1) && (e = e.substr(0, e.length - 1)),
                        oe[e] ? oe[e] : "#" === e.charAt(0) ? (4 === e.length && (t = e.charAt(1),
                            i = e.charAt(2),
                            n = e.charAt(3),
                            e = "#" + t + t + i + i + n + n),
                            e = parseInt(e.substr(1), 16),
                            [e >> 16, 255 & e >> 8, 255 & e]) : "hsl" === e.substr(0, 3) ? (e = e.match(g),
            ...
            var pe = function (e, t, i, n) {
                if (null == e)
                    return function (e) {
                        ...
                        ;
                var r, s = t ? (e.match(ce) || [""])[0] : "", a = e.split(s).join("").match(_) || [],
                    o = e.substr(0, e.indexOf(a[0])), l = ")" === e.charAt(e.length - 1) ? ")" : "",
                    u = -1 !== e.indexOf(" ") ? " " : ",", c = a.length, p = c > 0 ? a[0].replace(g, "") : "";
                return c ? r = t ? function (e) {
                        var t, h, d, f;
                        if ("number" == typeof e)
                            e += p;
                        else if (n && A.test(e)) {
                            for (f = e.replace(A, "|").split("|"),
                                     d = 0; f.length > d; d++)
                                f[d] = r(f[d]);
                            return f.join(",")
                        }
                        if (t = (e.match(ce) || [s])[0],
                                h = e.split(t).join("").match(_) || [],
                                d = h.length,
                            c > d--)
                            for (; c > ++d;)
                                h[d] = i ? h[0 | (d - 1) / 2] : a[d];
                ...
                , de = (B._setPluginRatio = function (e) {
                    ...
                    for (var t, i, n, r, s = this.data, a = s.proxy, o = s.firstMPT, l = 1e-6; o;)
                        t = a[o.v],
                ...
                , fe = (B._parseToProxy = function (e, t, i, n, r, s) {
                    var a, o, l, u, c, p = n, h = {}, d = {}, f = i._transform, m = L;
                    for (i._transform = null,
                         ...
                         s && (i._transform = f,
                         p && (p._prev = null,
                         p._prev && (p._prev._next = null))); n && n !== p;) {
                        if (1 >= n.type && (o = n.p,
                                d[o] = n.s + n.c,
                                h[o] = n.s,
                            s || (u = new de(n, "s", o, u, n.r),
                                n.c = 0),
                            1 === n.type))
                            for (a = n.l; --a > 0;)
                                l = "xn" + a,
                ...
                i = i || s || "",
                    a = new fe(e, t, 0, 0, a, u ? 2 : 1, null, (!1), o, i, n),
                    n += "";
                var p, h, d, f, m, _, y, w, x, b, T, C, P = i.split(", ").join(",").split(" "),
                    k = n.split(", ").join(",").split(" "), D = P.length, O = c !== !1;
                for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (P = P.join(" ").replace(A, ", ").split(" "),
                    k = k.join(" ").replace(A, ", ").split(" "),
                    D = P.length),
                     D !== k.length && (P = (s || "").split(" "),
                         D = P.length),
                         a.plugin = l,
                         a.setRatio = u,
                         p = 0; D > p; p++)
                    if (f = P[p],
                            ...
                            w = parseFloat(f),
                        w || 0 === w)
                        a.appendXtra("", w, re(m, w), m.replace(v, ""), O && -1 !== m.indexOf("px"), !0);
                    else if (r && ("#" === f.charAt(0) || oe[f] || S.test(f)))
                        C = "," === m.charAt(m.length - 1) ? ")," : ")",
                            f = ue(f),
                            m = ue(m),
                            x = f.length + m.length > 6,
                            x && !q && 0 === m[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent",
                                a.e = a.e.split(k[p]).join("transparent")) : (q || (x = !1),
                                a.appendXtra(x ? "rgba(" : "rgb(", f[0], m[0] - f[0], ",", !0, !0).appendXtra("", f[1], m[1] - f[1], ",", !0).appendXtra("", f[2], m[2] - f[2], x ? "," : C, !0),
                            x && (f = 4 > f.length ? 1 : f[3],
                                a.appendXtra("", f, (4 > m.length ? 1 : m[3]) - f, C, !1)));
                    else if (_ = f.match(g)) {
                        if (y = m.match(v),
                            !y || y.length !== _.length)
                            return a;
                        for (d = 0,
                            ...
                            T = _[h],
                                b = f.indexOf(T, d),
                                a.appendXtra(f.substr(d, b - d), Number(T), re(y[h], T), "", O && "px" === f.substr(b + T.length, 2), 0 === h),
                                d = b + T.length;
                        a["xs" + a.l] += f.substr(d)
                    } else
                        a["xs" + a.l] += a.l ? " " + f : f;
            ...
            u.xs0 = "",
                ...
                u.appendXtra = function (e, t, i, n, r, s) {
                    var a = this
                        , o = a.l;
                    return a["xs" + o] += s && o ? " " + e : e || "",
                        i || 0 === o || a.plugin ? (a.l++,
                            ...
                            o > 0 ? (a.data["xn" + o] = t + i,
                                a.rxp["xn" + o] = r,
                                a["xn" + o] = t,
                            a.plugin || (a.xfirst = new fe(a, "xn" + o, t, i, a.xfirst || a, 0, a.n, r, a.pr),
                                a.xfirst.xs0 = 0),
                                a) : (a.data = {
                                s: t + i
                            },
            ...
            var ve = function (e, t) {
                ...
                var n, r, s = e.split(","), a = t.defaultValue;
                for (i = i || [a],
                         n = 0; s.length > n; n++)
                    ...
                    _e(e, {
                        parser: function (e, i, n, r, s, a, u) {
                            ...
                            return c ? (c._cssRegister(),
                                l[n].parse(e, i, n, r, s, a, u)) : ($("Error: " + t + " js file not loaded."),
                                s)
                        }
                    })
                }
            ...
            u = ve.prototype,
                u.parseComplex = function (e, t, i, n, r, s) {
                    var a, o, l, u, c, p, h = this.keyword;
                    if (this.multi && (A.test(i) || A.test(t) ? (o = t.replace(A, "|").split("|"),
                            l = i.replace(A, "|").split("|")) : h && (o = [t],
                            l = [i])),
                            l) {
                        for (u = l.length > o.length ? l.length : o.length,
                            ...
                            h && (c = t.indexOf(h),
                                p = i.indexOf(h),
                            c !== p && (-1 === p ? o[a] = o[a].split(h).join("") : -1 === c && (o[a] += " " + h)));
                        t = o.join(", "),
                            i = l.join(", ")
                    }
            ...
            var we,
                xe = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                be = Y("transform"), Te = W + "transform", Se = Y("transformOrigin"), Ce = null !== Y("perspective"),
                Pe = B.Transform = function () {
                    this.perspective = parseFloat(a.defaultTransformPerspective) || 0,
                        this.force3D = !(a.defaultForce3D === !1 || !Ce) && (a.defaultForce3D || "auto")
                }
                , ke = window.SVGElement, De = function (e, t, i) {
                    var n, r = I.createElementNS("http://www.w3.org/2000/svg", e), s = /([a-z])([A-Z])/g;
                    for (n in i)
                    ...
                    return I.createElementNS && !n && (e = De("svg", Oe),
                        t = De("rect", e, {
                            width: 100,
                            height: 50,
                            x: 100
                        ...
                        t.style[Se] = "50% 50%",
                        t.style[be] = "scaleX(0.5)",
                        n = i === t.getBoundingClientRect().width && !(d && Ce),
                        Oe.removeChild(e)),
                        n
                }(), Me = function (e, t, i, n) {
                    var r, s;
                    n && (s = n.split(" ")).length || (r = e.getBBox(),
                        t = ne(t).split(" "),
                        s = [(-1 !== t[0].indexOf("%") ? parseFloat(t[0]) / 100 * r.width : parseFloat(t[0])) + r.x, (-1 !== t[1].indexOf("%") ? parseFloat(t[1]) / 100 * r.height : parseFloat(t[1])) + r.y]),
                    ...
                    var s, o, l, u, c, p, h, d, f, m, g = i ? e._gsTransform || new Pe : new Pe, v = 0 > g.scaleX, _ = 2e-5,
                        y = 1e5, w = Ce ? parseFloat(U(e, Se, t, !1, "0 0 0").split(" ")[2]) || g.zOrigin || 0 : 0,
                        x = parseFloat(a.defaultTransformPerspective) || 0;
                    if (be ? o = U(e, Te, t, !0) : e.currentStyle && (o = e.currentStyle.filter.match(E),
                            o = o && 4 === o.length ? [o[0].substr(4), Number(o[2].substr(4)), Number(o[1].substr(4)), o[3].substr(4), g.x || 0, g.y || 0].join(",") : ""),
                            s = !o || "none" === o || "matrix(1, 0, 0, 1, 0, 0)" === o,
                            g.svg = !!(ke && "function" == typeof e.getBBox && e.getCTM && (!e.parentNode || e.parentNode.getBBox && e.parentNode.getCTM)),
                        g.svg && (s && -1 !== (e.style[be] + "").indexOf("matrix") && (o = e.style[be],
                            s = !1),
                            Me(e, U(e, Se, r, !1, "50% 50%") + "", g, e.getAttribute("data-svg-origin")),
                            we = a.useSVGTransformAttr || Ee,
                        ...
                        for (l = (o || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [],
                                 u = l.length; --u > -1;)
                            c = Number(l[u]),
                                l[u] = (p = c - (c |= 0)) ? (0 | p * y + (0 > p ? -.5 : .5)) / y + c : c;
                        if (16 === l.length) {
                            var b, T, S, C, P, k = l[0], D = l[1], O = l[2], M = l[3], A = l[4], R = l[5], L = l[6],
                                I = l[7], z = l[8], F = l[9], j = l[10], B = l[12], X = l[13], q = l[14], H = l[11],
                                $ = Math.atan2(L, j);
                            g.zOrigin && (q = -g.zOrigin,
                                B = z * q - l[12],
                                X = F * q - l[13],
                                q = j * q + g.zOrigin - l[14]),
                                g.rotationX = $ * N,
                            $ && (C = Math.cos(-$),
                                P = Math.sin(-$),
                                b = A * C + z * P,
                            ...
                            g.rotationX && Math.abs(g.rotationX) + Math.abs(g.rotation) > 359.9 && (g.rotationX = g.rotation = 0,
                                g.rotationY += 180),
                                g.scaleX = (0 | Math.sqrt(k * k + D * D) * y + .5) / y,
                                g.scaleY = (0 | Math.sqrt(R * R + F * F) * y + .5) / y,
                                g.scaleZ = (0 | Math.sqrt(L * L + j * j) * y + .5) / y,
                                g.skewX = 0,
                                g.perspective = H ? 1 / (0 > H ? -H : H) : 0,
                                g.x = B,
                                g.y = X,
                                g.z = q,
                            g.svg && (g.x -= g.xOrigin - (g.xOrigin * k - g.yOrigin * A),
                                g.y -= g.yOrigin - (g.yOrigin * D - g.xOrigin * R))
                            ...
                            g.x = l[4] || 0,
                                ...
                                h = Math.sqrt(V * V + Y * Y),
                                d = Math.sqrt(Q * Q + G * G),
                                f = V || Y ? Math.atan2(Y, V) * N : g.rotation || 0,
                                m = G || Q ? Math.atan2(G, Q) * N + f : g.skewX || 0,
                            Math.abs(m) > 90 && 270 > Math.abs(m) && (v ? (h *= -1,
                                m += 0 >= f ? 180 : -180,
                                f += 0 >= f ? 180 : -180) : (d *= -1,
                                m += 0 >= m ? 180 : -180)),
                                g.scaleX = h,
                            ...
                            Ce && (g.rotationX = g.rotationY = g.z = 0,
                                g.perspective = x,
                                g.scaleZ = 1),
                            g.svg && (g.x -= g.xOrigin - (g.xOrigin * V - g.yOrigin * Y),
                                g.y -= g.yOrigin - (g.yOrigin * Q - g.xOrigin * G))
                        }
                        g.zOrigin = w;
                        for (u in g)
                            _ > g[u] && g[u] > -_ && (g[u] = 0)
                    }
                    return i && (e._gsTransform = g,
                    g.svg && (we && e.style[be] ? Ie(e.style, be) : !we && e.getAttribute("transform") && e.removeAttribute("transform"))),
                        g
                }
                , Re = function (e) {
                    var t, i, n = this.data, r = -n.rotation * R, s = r + n.skewX * R, a = 1e5,
                        o = (0 | Math.cos(r) * n.scaleX * a) / a, l = (0 | Math.sin(r) * n.scaleX * a) / a,
                        u = (0 | Math.sin(s) * -n.scaleY * a) / a, c = (0 | Math.cos(s) * n.scaleY * a) / a,
                        p = this.t.style, h = this.t.currentStyle;
                    if (h) {
                        i = l,
                            l = -u,
                            u = -i,
                            t = h.filter,
                            p.filter = "";
                        var d, f, g = this.t.offsetWidth, v = this.t.offsetHeight, _ = "absolute" !== h.position,
                        ...
                        if (null != n.ox && (d = (n.oxp ? .01 * g * n.ox : n.ox) - g / 2,
                                ...
                                _ ? (d = g / 2,
                                    f = v / 2,
                                    y += ", Dx=" + (d - (d * o + f * l) + b) + ", Dy=" + (f - (d * u + f * c) + T) + ")") : y += ", sizingMethod='auto expand')",
                                p.filter = -1 !== t.indexOf("DXImageTransform.Microsoft.Matrix(") ? t.replace(M, y) : y + " " + t,
                            (0 === e || 1 === e) && 1 === o && 0 === l && 0 === u && 1 === c && (_ && -1 === y.indexOf("Dx=0, Dy=0") || x.test(t) && 100 !== parseFloat(RegExp.$1) || -1 === t.indexOf(t.indexOf("Alpha")) && p.removeAttribute("filter")),
                                !_) {
                            var S, C, P, k = 8 > m ? 1 : -1;
                            for (d = n.ieOffsetX || 0,
                                     f = n.ieOffsetY || 0,
                                     n.ieOffsetX = Math.round((g - ((0 > o ? -o : o) * g + (0 > l ? -l : l) * v)) / 2 + b),
                                     n.ieOffsetY = Math.round((v - ((0 > c ? -c : c) * v + (0 > u ? -u : u) * g)) / 2 + T),
                                     ge = 0; 4 > ge; ge++)
                                C = te[ge],
                                    S = h[C],
                                    i = -1 !== S.indexOf("px") ? parseFloat(S) : Q(this.t, C, parseFloat(S), S.replace(w, "")) || 0,
                                    P = i !== n[C] ? 2 > ge ? -n.ieOffsetX : -n.ieOffsetY : 2 > ge ? d - n.ieOffsetX : f - n.ieOffsetY,
                                    p[C] = (n[C] = Math.round(i - P * (0 === ge || 2 === ge ? 1 : k))) + "px"
                        }
                    }
                }, Ne = B.set3DTransformRatio = B.setTransformRatio = function (e) {
                    var t, i, n, r, s, a, o, l, u, c, p, h, f, m, g, v, _, y, w, x, b, T, S, C = this.data,
                        P = this.t.style, k = C.rotation, D = C.rotationX, O = C.rotationY, E = C.scaleX, M = C.scaleY,
                        A = C.scaleZ, N = C.x, L = C.y, I = C.z, z = C.svg, F = C.perspective, j = C.force3D;
                    if (!((1 !== e && 0 !== e || "auto" !== j || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && j || I || F || O || D) || we && z || !Ce)
                        return void (k || C.skewX || z ? (k *= R,
                            T = C.skewX * R,
                            S = 1e5,
                            t = Math.cos(k) * E,
                            r = Math.sin(k) * E,
                            i = Math.sin(k - T) * -M,
                            s = Math.cos(k - T) * M,
                        T && "simple" === C.skewType && (_ = Math.tan(T),
                            _ = Math.sqrt(1 + _ * _),
                            i *= _,
                            s *= _,
                        C.skewY && (t *= _,
                            r *= _)),
                        z && (N += C.xOrigin - (C.xOrigin * t + C.yOrigin * i),
                            L += C.yOrigin - (C.xOrigin * r + C.yOrigin * s),
                            m = 1e-6,
                        m > N && N > -m && (N = 0),
                        m > L && L > -m && (L = 0)),
                            w = (0 | t * S) / S + "," + (0 | r * S) / S + "," + (0 | i * S) / S + "," + (0 | s * S) / S + "," + N + "," + L + ")",
                            z && we ? this.t.setAttribute("transform", "matrix(" + w) : P[be] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + w) : P[be] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + E + ",0,0," + M + "," + N + "," + L + ")");
                    if (d && (m = 1e-4,
                        m > E && E > -m && (E = A = 2e-5),
                        m > M && M > -m && (M = A = 2e-5),
                        ...
                        C.skewX && (k -= C.skewX * R,
                            g = Math.cos(k),
                            v = Math.sin(k),
                        "simple" === C.skewType && (_ = Math.tan(C.skewX * R),
                            _ = Math.sqrt(1 + _ * _),
                            g *= _,
                            v *= _,
                        C.skewY && (t *= _,
                        ...
                        if (!(O || D || 1 !== A || F || z))
                            return void (P[be] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) translate3d(" : "translate3d(") + N + "px," + L + "px," + I + "px)" + (1 !== E || 1 !== M ? " scale(" + E + "," + M + ")" : ""));
                        t = s = 1,
                            i = r = 0
                    }
                    u = 1,
                    ...
                    m > I && I > -m && (I = 0)),
                        ...
                        w += (m > t && t > -m ? b : t) + x + (m > r && r > -m ? b : r) + x + (m > o && o > -m ? b : o),
                        w += x + (m > c && c > -m ? b : c) + x + (m > i && i > -m ? b : i) + x + (m > s && s > -m ? b : s),
                        D || O ? (w += x + (m > l && l > -m ? b : l) + x + (m > p && p > -m ? b : p) + x + (m > n && n > -m ? b : n),
                            w += x + (m > a && a > -m ? b : a) + x + (m > u && u > -m ? b : u) + x + (m > h && h > -m ? b : h) + x) : w += ",0,0,0,0,1,0,",
                        w += N + x + L + x + I + x + (F ? 1 + -I / F : 1) + ")",
                        P[be] = w
                }
            ;
            u = Pe.prototype,
                ...
                _e("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                    parser: function (e, t, i, n, s, o, l) {
                        if (n._lastParsedTransform === l)
                            return s;
                        n._lastParsedTransform = l;
                        var u, c, p, h, d, f, m, g = n._transform = Ae(e, r, !0, l.parseTransform), v = e.style,
                            _ = 1e-6, y = xe.length, w = l, x = {};
                        if ("string" == typeof w.transform && be)
                            p = F.style,
                                p[be] = w.transform,
                                p.display = "block",
                                p.position = "absolute",
                            ...
                            "string" == typeof w.x && -1 !== w.x.indexOf("%") && (u.x = 0,
                                u.xPercent = se(w.x, g.xPercent)),
                            "string" == typeof w.y && -1 !== w.y.indexOf("%") && (u.y = 0,
                                u.yPercent = se(w.y, g.yPercent)),
                                u.rotation = ae("rotation" in w ? w.rotation : "shortRotation" in w ? w.shortRotation + "_short" : "rotationZ" in w ? w.rotationZ : g.rotation, g.rotation, "rotation", x),
                            Ce && (u.rotationX = ae("rotationX" in w ? w.rotationX : "shortRotationX" in w ? w.shortRotationX + "_short" : g.rotationX || 0, g.rotationX, "rotationX", x),
                                u.rotationY = ae("rotationY" in w ? w.rotationY : "shortRotationY" in w ? w.shortRotationY + "_short" : g.rotationY || 0, g.rotationY, "rotationY", x)),
                                u.skewX = null == w.skewX ? g.skewX : ae(w.skewX, g.skewX),
                                u.skewY = null == w.skewY ? g.skewY : ae(w.skewY, g.skewY),
                            (c = u.skewY - g.skewY) && (u.skewX += c,
                                u.rotation += c)
                        }
                        for (Ce && null != w.force3D && (g.force3D = w.force3D,
                            f = !0),
                                 g.skewType = w.skewType || g.skewType || a.defaultSkewType,
                                 d = g.force3D || g.z || g.rotationX || g.rotationY || u.z || u.rotationX || u.rotationY || u.perspective,
                             d || null == w.scale || (u.scaleZ = 1); --y > -1;)
                            i = xe[y],
                                h = u[i] - g[i],
                            (h > _ || -_ > h || null != w[i] || null != L[i]) && (f = !0,
                                s = new fe(g, i, g[i], h, s),
                            i in x && (s.e = x[i]),
                                s.xs0 = 0,
                                s.plugin = o,
                                n._overwriteProps.push(s.n));
                        return h = w.transformOrigin,
                        g.svg && (h || w.svgOrigin) && (Me(e, ne(h), u, w.svgOrigin),
                            s = new fe(g, "xOrigin", g.xOrigin, u.xOrigin - g.xOrigin, s, (-1), "transformOrigin"),
                            s.b = g.xOrigin,
                            s.e = s.xs0 = u.xOrigin,
                            s = new fe(g, "yOrigin", g.yOrigin, u.yOrigin - g.yOrigin, s, (-1), "transformOrigin"),
                            s.b = g.yOrigin,
                            s.e = s.xs0 = u.yOrigin,
                            h = we ? null : "0px 0px"),
                        (h || Ce && d && g.zOrigin) && (be ? (f = !0,
                            i = Se,
                            h = (h || U(e, i, r, !1, "50% 50%")) + "",
                            s = new fe(v, i, 0, 0, s, (-1), "transformOrigin"),
                            s.b = v[i],
                            s.plugin = o,
                            Ce ? (p = g.zOrigin,
                                h = h.split(" "),
                                g.zOrigin = (h.length > 2 && (0 === p || "0px" !== h[2]) ? parseFloat(h[2]) : p) || 0,
                                s.xs0 = s.e = h[0] + " " + (h[1] || "50%") + " 0px",
                                s = new fe(g, "zOrigin", 0, 0, s, (-1), s.n),
                                s.b = p,
                                s.xs0 = s.e = g.zOrigin) : s.xs0 = s.e = h) : ne(h + "", g)),
                        f && (n._transformType = g.svg && we || !d && 3 !== this._transformType ? 2 : 3),
                            s
                    },
                    prefix: !0
                }),
                ...
                _e("borderRadius", {
                    ...
                    parser: function (e, t, i, s, a) {
                        t = this.format(t);
                        var o, l, u, c, p, h, d, f, m, g, v, _, y, w, x, b,
                        ...
                        for (m = parseFloat(e.offsetWidth),
                            ...
                            -1 !== p.indexOf(" ") && (c = p.split(" "),
                                ...
                                y ? (f = parseInt(h.charAt(0) + "1", 10),
                                    ...
                                    v = h.substr((f + "").length)),
                            "" === v && (v = n[i] || _),
                            v !== _ && (w = Q(e, "borderLeft", d, _),
                                x = Q(e, "borderTop", d, _),
                                "%" === v ? (p = 100 * (w / m) + "%",
                                    c = 100 * (x / g) + "%") : "em" === v ? (b = Q(e, "borderLeft", 1, "em"),
                                    p = w / b + "em",
                                    c = x / b + "em") : (p = w + "px",
                                    c = x + "px"),
                            y && (h = parseFloat(p) + f + v,
                                u = parseFloat(c) + f + v)),
                                a = me(S, T[l], p + " " + c, h + " " + u, !1, "0px", a);
                        return a
                    },
                    prefix: !0,
                ...
                _e("backgroundPosition", {
                    ...
                    parser: function (e, t, i, n, s, a) {
                        var o, l, u, c, p, h, d = "background-position", f = r || G(e, null),
                            ...
                            v = this.format(t);
                        if (-1 !== g.indexOf("%") != (-1 !== v.indexOf("%")) && (h = U(e, "backgroundImage").replace(k, ""),
                            h && "none" !== h)) {
                            for (o = g.split(" "),
                                     l = v.split(" "),
                                ...
                                g = o[u],
                                    c = -1 !== g.indexOf("%"),
                                c !== (-1 !== l[u].indexOf("%")) && (p = 0 === u ? e.offsetWidth - j.width : e.offsetHeight - j.height,
                                    o[u] = c ? parseFloat(g) / 100 * p + "px" : 100 * (parseFloat(g) / p) + "%");
                            g = o.join(" ")
                        }
                ...
                _e("clip", {
                    ...
                    parser: function (e, t, i, n, s, a) {
                        ...
                        return 9 > m ? (l = e.currentStyle,
                            ...
                            t = this.format(t).split(",").join(u)) : (o = this.format(U(e, this.p, r, !1, this.dflt)),
                            t = this.format(t)),
            ...
            var Le = function (e) {
                var t, i = this.t, n = i.filter || U(this.data, "filter") || "", r = 0 | this.s + this.c * e;
                100 === r && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"),
                    t = !U(this.data, "filter")) : (i.filter = n.replace(T, ""),
                    t = !0)),
            ...
            _e("opacity,alpha,autoAlpha", {
                ...
                parser: function (e, t, i, n, s, a) {
                    ...
                    u && 1 === o && "hidden" === U(e, "visibility", r) && 0 !== t && (o = 0),
                        q ? s = new fe(l, "opacity", o, t - o, s) : (s = new fe(l, "opacity", 100 * o, 100 * (t - o), s),
                            s.xn1 = u ? 1 : 0,
                            l.zoom = 1,
                            s.type = 2,
                            ...
                            s.plugin = a,
                            s.setRatio = Le),
                    u && (s = new fe(l, "visibility", 0, 0, s, (-1), null, (!1), 0, 0 !== o ? "inherit" : "hidden", 0 === t ? "hidden" : "inherit"),
                        s.xs0 = "inherit",
                        n._overwriteProps.push(s.n),
            ...
            _e("className", {
                parser: function (e, t, n, s, a, o, l) {
                    var u, c, p, h, d, f = e.getAttribute("class") || "", m = e.style.cssText;
                    if (a = s._classNamePT = new fe(e, n, 0, 0, a, 2),
                            a.setRatio = ze,
                            a.pr = -11,
                            i = !0,
                            a.b = f,
                    ...
                    return e._gsClassPT = a,
                        a.e = "=" !== t.charAt(1) ? t : f.replace(RegExp("\\s*\\b" + t.substr(2) + "\\b"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : ""),
            ...
            var Fe = function (e) {
                if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    var t, i, n, r, s, a = this.t.style, o = l.transform.parse;
                    if ("all" === this.e)
                        a.cssText = "",
                            r = !0;
                    else
            ...
            u = a.prototype,
                ...
                u._onInitTween = function (e, t, o) {
                    ...
                    if (p && "" === T.zIndex && (u = U(e, "zIndex", r),
                        ("auto" === u || "" === u) && this._addLazySet(T, "zIndex", 0)),
                        "string" == typeof t && (g = T.cssText,
                            u = K(e, r),
                            T.cssText = g + ";" + t,
                            u = J(e, u, K(e)).difs,
                        !q && b.test(t) && (u.opacity = parseFloat(RegExp.$1)),
                            t = u,
                            T.cssText = g),
                            this._firstPT = d = t.className ? l.className.parse(e, t.className, "className", this, null, null, t) : this.parse(e, t, null),
                            this._transformType) {
                        for (x = 3 === this._transformType,
                                 be ? h && (p = !0,
                                 "" === T.zIndex && (y = U(e, "zIndex", r),
                                 ...
                                 m = d; m && m._next;)
                            m = m._next;
                        w = new fe(e, "transform", 0, 0, null, 2),
                            this._linkCSSP(w, null, m),
                            w.setRatio = be ? Ne : Re,
                            w.data = this._transform || Ae(e, r, !0),
                            w.tween = o,
                            w.pr = -1,
                            s.pop()
                    }
                    if (i) {
                        for (; d;) {
                            for (_ = d._next,
                                     m = g; m && m.pr > d.pr;)
                                m = m._next;
                            (d._prev = m ? m._prev : v) ? d._prev._next = d : g = d,
                                (d._next = m) ? m._prev = d : v = d,
                                d = _
                        }
                        this._firstPT = g
                    }
                ...
                u.parse = function (e, t, i, s) {
                    ...
                    for (a in t)
                        d = t[a],
                            o = l[a],
                            o ? i = o.parse(e, d, a, this, i, s, t) : (h = U(e, a, r) + "",
                                g = "string" == typeof d,
                                "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || g && S.test(d) ? (g || (d = ue(d),
                                    d = (d.length > 3 ? "rgba(" : "rgb(") + d.join(",") + ")"),
                                    i = me(_, a, h, d, !0, "transparent", i, 0, s)) : !g || -1 === d.indexOf(" ") && -1 === d.indexOf(",") ? (u = parseFloat(h),
                                    f = u || 0 === u ? h.substr((u + "").length) : "",
                                ("" === h || "auto" === h) && ("width" === a || "height" === a ? (u = ie(e, a, r),
                                    f = "px") : "left" === a || "top" === a ? (u = Z(e, a, r),
                                    f = "px") : (u = "opacity" !== a ? 0 : 1,
                                    f = "")),
                                    v = g && "=" === d.charAt(1),
                                    v ? (p = parseInt(d.charAt(0) + "1", 10),
                                        d = d.substr(2),
                                        p *= parseFloat(d),
                                        m = d.replace(w, "")) : (p = parseFloat(d),
                                        m = g ? d.replace(w, "") : ""),
                                "" === m && (m = a in n ? n[a] : f),
                                    d = p || 0 === p ? (v ? p + u : p) + m : t[a],
                                f !== m && "" !== m && (p || 0 === p) && u && (u = Q(e, a, u, f),
                                    "%" === m ? (u /= Q(e, a, 100, "%") / 100,
                                    t.strictUnits !== !0 && (h = u + "%")) : "em" === m ? u /= Q(e, a, 1, "em") : "px" !== m && (p = Q(e, a, p, m),
                                        m = "px"),
                                v && (p || 0 === p) && (d = p + u + m)),
                                v && (p += u),
                                    !u && 0 !== u || !p && 0 !== p ? void 0 !== _[a] && (d || "NaN" != d + "" && null != d) ? (i = new fe(_, a, p || u || 0, 0, i, (-1), a, (!1), 0, h, d),
                                        i.xs0 = "none" !== d || "display" !== a && -1 === a.indexOf("Style") ? d : h) : $("invalid " + a + " tween value: " + t[a]) : (i = new fe(_, a, u, p - u, i, 0, a, c !== !1 && ("px" === m || "zIndex" === a), 0, h, d),
                                        i.xs0 = m)) : i = me(_, a, h, d, !0, null, i, 0, s)),
                        s && i && !i.plugin && (i.plugin = s);
                    return i
                }
                ,
                u.setRatio = function (e) {
                    var t, i, n, r = this._firstPT, s = 1e-6;
                ...
                u._enableTransforms = function (e) {
                    this._transform = this._transform || Ae(this._target, r, !0),
            ...
            u._addLazySet = function (e, t, i) {
                ...
                u._kill = function (t) {
                    ...
                    return t.className && (i = this._classNamePT) && (r = i.xfirst,
            ...
            var Be = function (e, t, i) {
                ...
                if (e.slice)
                    ...
                    for (n = e.childNodes,
                        ...
                        s.style && (t.push(K(s)),
                        i && i.push(s)),
                        1 !== a && 9 !== a && 11 !== a || !s.childNodes.length || Be(s, t, i)
            };
            return a.cascadeTo = function (e, i, n) {
                var r, s, a, o, l = t.to(e, i, n), u = [l], c = [], p = [], h = [], d = t._internals.reservedProps;
        ...
        function () {
            ...
            t._onInitAllProps = function () {
                for (var e, t, i, n = this._tween, r = n.vars.roundProps instanceof Array ? n.vars.roundProps : n.vars.roundProps.split(","), s = r.length, a = {}, o = n._propLookup.roundProps; --s > -1;)
                    a[r[s]] = 1;
                for (s = r.length; --s > -1;)
                    for (e = r[s],
                             t = n._firstPT; t;)
                        i = t._next,
                            t.pg ? t.t._roundProps(a, !0) : t.n === e && (this._add(t.t, e, t.s, t.c),
                            i && (i._prev = t._prev),
        ...
        _gsScope._gsDefine.plugin({
            ...
            set: function (e) {
                ...
                for (var t, i = this._overwriteProps, n = i.length, r = 1 === e ? this._end : e ? this._proxy : this._start; --n > -1;)
                    t = i[n],
                        this._target.setAttribute(t, r[t] + "")
            }
        }),
        _gsScope._gsDefine.plugin({
            ...
            init: function (e, t) {
                "object" != typeof t && (t = {
                    ...
                    this.finals = {};
                var i, n, r, s, a, o, l = t.useRadians === !0 ? 2 * Math.PI : 360, u = 1e-6;
                for (i in t)
                    "useRadians" !== i && (o = (t[i] + "").split("_"),
                        n = o[0],
                        r = parseFloat("function" != typeof e[i] ? e[i] : e[i.indexOf("set") || "function" != typeof e["get" + i.substr(3)] ? i : "get" + i.substr(3)]()),
                        s = this.finals[i] = "string" == typeof n && "=" === n.charAt(1) ? r + parseInt(n.charAt(0) + "1", 10) * Number(n.substr(2)) : Number(n) || 0,
                        a = s - r,
                    o.length && (n = o.join("_"),
                    -1 !== n.indexOf("short") && (a %= l,
                    a !== a % (l / 2) && (a = 0 > a ? a + l : a - l)),
                        -1 !== n.indexOf("_cw") && 0 > a ? a = (a + 9999999999 * l) % l - (0 | a / l) * l : -1 !== n.indexOf("ccw") && a > 0 && (a = (a - 9999999999 * l) % l - (0 | a / l) * l)),
                    (a > u || -u > a) && (this._addTween(e, i, r, r + a, i),
                        this._overwriteProps.push(i)));
                return !0
            },
            set: function (e) {
        ...
        _gsScope._gsDefine("easing.Back", ["easing.Ease"], function (e) {
            var t, i, n, r = _gsScope.GreenSockGlobals || _gsScope, s = r.com.greensock, a = 2 * Math.PI,
                o = Math.PI / 2, l = s._class, u = function (t, i) {
            ...
            return g.constructor = m,
                ...
                i = l("easing.RoughEase", function (t) {
                    t = t || {};
                    for (var i, n, r, s, a, o, l = t.taper || "none", u = [], c = 0, p = 0 | (t.points || 20), d = p, f = t.randomize !== !1, m = t.clamp === !0, g = t.template instanceof e ? t.template : null, v = "number" == typeof t.strength ? .4 * t.strength : .4; --d > -1;)
                        i = f ? Math.random() : 1 / p * d,
                            n = g ? g.getRatio(i) : i,
        ...
        if (!i.TweenLite) {
            var n, r, s, a, o, l = function (e) {
                    ...
                    for (t = 0; n.length > t; t++)
                        r[n[t]] = r = r[n[t]] || {};
                    return r
                }, u = l("com.greensock"), c = 1e-10, p = function (e) {
                    var t, i = [], n = e.length;
                    for (t = 0; t !== n; i.push(e[t++]))
                        ;
                    return i
                    ...
                    this.check = function (u) {
                        for (var c, p, h, d, g = r.length, v = g; --g > -1;)
                            (c = f[r[g]] || new m(r[g], [])).gsClass ? (o[g] = c.gsClass,
                                v--) : u && c.sc.push(this);
                        if (0 === v && s)
                            for (p = ("com.greensock." + n).split("."),
                                     h = p.pop(),
                                     d = l(p.join("."))[h] = this.gsClass = s.apply(s, o),
                                 a && (i[h] = d,
                                     "function" == typeof define && define.amd ? define((e.GreenSockAMDPath ? e.GreenSockAMDPath + "/" : "") + n.split(".").pop(), [], function () {
                                         return d
                                     }) : n === t && "undefined" != typeof module && module.exports && (module.exports = d)),
                ...
                , b = w.register = function (e, t, i, n) {
                    for (var r, s, a, o, l = t.split(","), c = l.length, p = (i || "easeIn,easeOut,easeInOut").split(","); --c > -1;)
                        for (s = l[c],
                                 ...
                                 a = p.length; --a > -1;)
                            o = p[a],
                                x[s + "." + o] = x[o + s] = r[o] = e.getRatio ? e : e[o] || new e
                }
            ;
            for (s = w.prototype,
                     s._calcEnd = !1,
                     ...
                     r = n.length; --r > -1;)
                s = n[r] + ",Power" + r,
                    b(new w(null, null, 1, r), s, "easeOut", !0),
                    b(new w(null, null, 2, r), s, "easeIn" + (0 === r ? ",easeNone" : "")),
                    b(new w(null, null, 3, r), s, "easeInOut");
            ...
            s = T.prototype,
                s.addEventListener = function (e, t, i, n, r) {
                    r = r || 0;
                    var s, l, u = this._listeners[e], c = 0;
                    for (null == u && (this._listeners[e] = u = []),
                             l = u.length; --l > -1;)
                        s = u[l],
                            s.c === t && s.s === i ? u.splice(l, 1) : 0 === c && r > s.pr && (c = l + 1);
                    u.splice(c, 0, {
                        c: t,
                        s: i,
                        up: n,
            ...
            for (n = ["ms", "moz", "webkit", "o"],
                     r = n.length; --r > -1 && !S;)
                S = e[n[r] + "RequestAnimationFrame"],
                    C = e[n[r] + "CancelAnimationFrame"] || e[n[r] + "CancelRequestAnimationFrame"];
            v("Ticker", function (e, t) {
                var i, n, r, s, l, u = this, p = P(), d = t !== !1 && S, f = 500, m = 33, g = "tick", v = function (e) {
                    var t, a, o = P() - k;
                    o > f && (p += o - m),
                        k += o,
                        u.time = (k - p) / 1e3,
                ...
                T.call(u),
                    ...
                    ,
                    u.wake = function () {
                        null !== r ? u.sleep() : u.frame > 10 && (k = P() - f + 5),
                            n = 0 === i ? h : d && S ? S : function (e) {
            ...
            O(),
                ...
                s.eventCallback = function (e, t, i, n) {
                    if ("on" === (e || "").substr(0, 2)) {
                        ...
                        null == t ? delete r[e] : (r[e] = t,
                            r[e + "Params"] = d(i) && -1 !== i.join("").indexOf("{self}") ? this._swapSelfInParams(i) : i,
                            r[e + "Scope"] = n),
                ...
                s.paused = function (e) {
                    ...
                    return e != this._paused && n && (o || e || a.wake(),
                        t = n.rawTime(),
                        i = t - this._pauseTime,
            ...
            var M = v("TweenLite", function (t, i, n) {
                ...
                if (this._overwrite = l = null == l ? X[M.defaultOverwrite] : "number" == typeof l ? l >> 0 : X[l],
                    (o || t instanceof Array || t.push && d(t)) && "number" != typeof t[0])
                    for (this._targets = a = p(t),
                        ...
                        s = a[r],
                            s ? "string" != typeof s ? s.length && s !== e && s[0] && (s[0] === e || s[0].nodeType && s[0].style && !s.nodeType) ? (a.splice(r--, 1),
                                this._targets = a = a.concat(p(s))) : (this._siblings[r] = V(s, this, !1),
                            1 === l && this._siblings[r].length > 1 && G(s, this, null, 1, this._siblings[r])) : (s = a[r--] = M.selector(s),
                            "string" == typeof s && a.splice(r + 1, 1)) : a.splice(r--, 1);
                else
                    this._propLookup = {},
                        this._siblings = V(t, this, !1),
                    1 === l && this._siblings.length > 1 && G(t, this, null, 1, this._siblings);
                ...
                var i, n = {};
                for (i in e)
                    B[i] || i in t && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!z[i] || z[i] && z[i]._autoCSS) || (n[i] = e[i],
                        delete e[i]);
                e.css = n
            };
            s = M.prototype = new D,
            ...
            H._startTime = a.time,
                ...
                D._updateRoot = M.render = function () {
                    ...
                    if (N.length && W(),
                        ...
                        if (i = H._first,
                            (!i || i._paused) && M.autoSleep && !q._first && 1 === a._listeners.tick.length) {
                            for (; i && i._paused;)
                                i = i._next;
                            i || a.sleep()
                        }
            ...
            var V = function (e, t, i) {
                ...
                if (1 === n || n >= 4) {
                    for (l = r.length,
                             s = 0; l > s; s++)
                        if ((o = r[s]) !== t)
                            o._gc || Y(o, t) && o._enabled(!1, !1) && (a = !0);
                        else if (5 === n)
                            break;
                    return a
                }
                var u, p = t._startTime + c, h = [], d = 0, f = 0 === t._duration;
                for (s = r.length; --s > -1;)
                    (o = r[s]) === t || o._gc || o._paused || (o._timeline !== t._timeline ? (u = u || U(t, 0, f),
                    0 === U(o, u, f) && (h[d++] = o)) : p >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > p && ((f || !o._initted) && 2e-10 >= p - o._startTime || (h[d++] = o)));
                for (s = d; --s > -1;)
                    if (o = h[s],
                ...
                return s /= r,
                    s > t ? s - t : i && s === t || !e._initted && 2 * c > s - t ? c : (s += e.totalDuration() / e._timeScale / r) > t + c ? 0 : s - t - c
            };
            s._init = function () {
                var e, t, i, n, r, s = this.vars, a = this._overwrittenProps, o = this._duration,
                    l = !!s.immediateRender, u = s.ease;
                if (s.startAt) {
                ...
                if (this._ease = u = u ? u instanceof w ? u : "function" == typeof u ? new w(u, s.easeParams) : x[u] || M.defaultEase : M.defaultEase,
                ...
                s._initProps = function (t, i, n, r) {
                    ...
                    if (null == t)
                        return !1;
                    L[t._gsTweenID] && W(),
                    this.vars.css || t.style && t !== e && t.nodeType && z.css && this.vars.autoCSS !== !1 && R(this.vars, t);
                    for (s in this.vars) {
                        if (c = this.vars[s],
                                B[s])
                    ...
                    return r && this._kill(r, t) ? this._initProps(t, i, n, r) : this._overwrite > 1 && this._firstPT && n.length > 1 && G(t, this, i, this._overwrite, n) ? (this._kill(i, t),
                        this._initProps(t, i, n, r)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (L[t._gsTweenID] = !0),
                        o)
                }
                ,
                s.render = function (e, t, i) {
                    ...
                    if (e >= l)
                        ...
                        (0 === e || 0 > u || u === c && "isPause" !== this.data) && u !== e && (i = !0,
                        ...
                        3 === h && (p *= 2),
                            ...
                            this.ratio = 1 === h ? 1 - p : 2 === h ? p : .5 > e / l ? p / 2 : 1 - p / 2
                    } else
                    ...
                    if (this._time !== o || i) {
                        ...
                        for (this._lazy !== !1 && (this._lazy = !1),
                             ...
                             this.vars.onStart && (0 !== this._time || 0 === l) && (t || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || y))),
                                 s = this._firstPT; s;)
                        ...
                        t || (this._time !== o || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || y)),
                        r && (!this._gc || i) && (0 > e && this._startAt && !this._onUpdate && e !== -1e-4 && this._startAt.render(e, t, i),
                        n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                            this._active = !1),
                        !t && this.vars[r] && this.vars[r].apply(this.vars[r + "Scope"] || this, this.vars[r + "Params"] || y),
            ...
            if (s = Q.prototype,
                    ...
                    Q.API = 2,
                    s._firstPT = null,
                    s._addTween = function (e, t, i, n, r, s) {
                        var a, o;
                    ...
                    Q.activate = function (e) {
                        for (var t = e.length; --t > -1;)
                            e[t].API === Q.API && (z[(new e[t])._propName] = e[t]);
                        return !0
                    }
                    ,
                    g.plugin = function (e) {
                        ...
                        }, e.global === !0), o = a.prototype = new Q(i);
                        o.constructor = a,
                            a.API = e.API;
                        for (t in s)
    ...
    !function () {
        ...
        var t, i = function (e, r) {
            ...
            function o() {
                _.autoplayTimeoutId = setTimeout(function () {
                    _.params.loop ? (_.fixLoop(),
                        _._slideNext()) : _.isEnd ? r.autoplayStopOnLast ? _.stopAutoplay() : _._slideTo(0) : _._slideNext()
                }, _.params.autoplay)
            }
            ...
            function c(e) {
                ...
                if (!_.params.allowSwipeToNext && (s() && 39 === t || !s() && 40 === t))
                    return !1;
                if (!_.params.allowSwipeToPrev && (s() && 37 === t || !s() && 38 === t))
                    return !1;
                if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                    if (37 === t || 39 === t || 38 === t || 40 === t) {
                        var i = !1;
                        if (_.container.parents(".swiper-slide").length > 0 && 0 === _.container.parents(".swiper-slide-active").length)
                            return;
                        var n = {
                        ...
                        for (var l = [[o.left, o.top], [o.left + _.width, o.top], [o.left, o.top + _.height], [o.left + _.width, o.top + _.height]], u = 0; u < l.length; u++) {
                            var c = l[u];
                    ...
                    s() ? ((37 === t || 39 === t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1),
            ...
            function p(e) {
                ...
                if (_.params.mousewheelInvert && (i = -i),
                        _.params.freeMode) {
                    var n = _.getWrapperTranslate() + i * _.params.mousewheelSensitivity;
                    if (n > 0 && (n = 0),
                        n < _.maxTranslate() && (n = _.maxTranslate()),
            ...
            if (_.params = r,
                    _.classNames = [],
                "undefined" != typeof t && "undefined" != typeof n && (t = n),
                ("undefined" != typeof t || (t = "undefined" == typeof n ? window.Dom7 || window.Zepto || window.jQuery : n)) && (_.$ = t,
                    _.container = t(e),
                0 !== _.container.length)) {
                if (_.container.length > 1)
                    return void _.container.each(function () {
                        new i(this, r)
                    });
                ...
                _.support.flexbox || (_.classNames.push("swiper-container-no-flexbox"),
                    _.params.slidesPerColumn = 1),
                (_.params.parallax || _.params.watchSlidesVisibility) && (_.params.watchSlidesProgress = !0),
                ["cube", "coverflow"].indexOf(_.params.effect) >= 0 && (_.support.transforms3d ? (_.params.watchSlidesProgress = !0,
                    _.classNames.push("swiper-container-3d")) : _.params.effect = "slide"),
                ...
                "cube" === _.params.effect && (_.params.resistanceRatio = 0,
                    ...
                    _.params.setWrapperSize = !1),
                "fade" === _.params.effect && (_.params.slidesPerView = 1,
                    _.params.slidesPerColumn = 1,
                    _.params.slidesPerGroup = 1,
                    _.params.watchSlidesProgress = !0,
                    _.params.spaceBetween = 0,
                "undefined" == typeof m && (_.params.virtualTranslate = !0)),
                ...
                _.params.paginationClickable && _.paginationContainer.addClass("swiper-pagination-clickable")),
                    _.rtl = s() && ("rtl" === _.container[0].dir.toLowerCase() || "rtl" === _.container.css("direction")),
                ...
                _.device.android && _.classNames.push("swiper-container-android"),
                    ...
                    ,
                _.params.grabCursor && (_.container[0].style.cursor = "move",
                    _.container[0].style.cursor = "-webkit-grab",
                    _.container[0].style.cursor = "-moz-grab",
                    _.container[0].style.cursor = "grab"),
                    _.imagesToLoad = [],
                    _.imagesLoaded = 0,
                    _.loadImage = function (e, t, i, n, r) {
                        function s() {
                            r && r()
                        }

                        var a;
                        e.complete && n ? s() : t ? (a = new window.Image,
                            a.onload = s,
                            a.onerror = s,
                            a.srcset = i,
                            a.src = t) : s()
                    ...
                    _.preloadImages = function () {
                        function e() {
                            "undefined" != typeof _ && null !== _ && (void 0 !== _.imagesLoaded && _.imagesLoaded++,
                        ...
                        for (var t = 0; t < _.imagesToLoad.length; t++)
                            _.loadImage(_.imagesToLoad[t], _.imagesToLoad[t].currentSrc || _.imagesToLoad[t].getAttribute("src"), _.imagesToLoad[t].srcset || _.imagesToLoad[t].getAttribute("srcset"), !0, e)
                    }
                    ,
                    ...
                    _.startAutoplay = function () {
                        return "undefined" == typeof _.autoplayTimeoutId && (!!_.params.autoplay && (!_.autoplaying && (_.autoplaying = !0,
                    ...
                    _.updateContainerSize = function () {
                        ...
                        0 === e && s() || 0 === t && !s() || (e = e - parseInt(_.container.css("padding-left"), 10) - parseInt(_.container.css("padding-right"), 10),
                            t = t - parseInt(_.container.css("padding-top"), 10) - parseInt(_.container.css("padding-bottom"), 10),
                            _.width = e,
                            _.height = t,
                            _.size = s() ? _.width : _.height)
                    }
                    ,
                    _.updateSlidesSize = function () {
                        _.slides = _.wrapper.children("." + _.params.slideClass),
                            ...
                            _.slidesGrid = [],
                            _.slidesSizesGrid = [];
                        var e, t = _.params.spaceBetween, i = -_.params.slidesOffsetBefore, n = 0, r = 0;
                        ...
                        var l, u = _.params.slidesPerColumn, c = o / u,
                        ...
                        for (e = 0; e < _.slides.length; e++) {
                            ...
                            if (_.params.slidesPerColumn > 1) {
                                var d, f, m;
                                "column" === _.params.slidesPerColumnFill ? (f = Math.floor(e / u),
                                    m = e - f * u,
                                (f > p || f === p && m === u - 1) && ++m >= u && (m = 0,
                                    f++),
                                    d = f + m * o / u,
                                    h.css({
                            ...
                            "none" !== h.css("display") && ("auto" === _.params.slidesPerView ? (l = s() ? h.outerWidth(!0) : h.outerHeight(!0),
                            _.params.roundLengths && (l = a(l))) : (l = (_.size - (_.params.slidesPerView - 1) * t) / _.params.slidesPerView,
                            _.params.roundLengths && (l = a(l)),
                                s() ? _.slides[e].style.width = l + "px" : _.slides[e].style.height = l + "px"),
                                _.slides[e].swiperSlideSize = l,
                                _.slidesSizesGrid.push(l),
                                _.params.centeredSlides ? (i = i + l / 2 + n / 2 + t,
                                0 === e && (i = i - _.size / 2 - t),
                                Math.abs(i) < .001 && (i = 0),
                                r % _.params.slidesPerGroup === 0 && _.snapGrid.push(i),
                                    _.slidesGrid.push(i)) : (r % _.params.slidesPerGroup === 0 && _.snapGrid.push(i),
                                    _.slidesGrid.push(i),
                                    i = i + l + t),
                                _.virtualSize += l + t,
                                n = l,
                        ...
                        if (_.rtl && _.wrongRTL && ("slide" === _.params.effect || "coverflow" === _.params.effect) && _.wrapper.css({
                            ...
                            _.params.slidesPerColumn > 1 && (_.virtualSize = (l + _.params.spaceBetween) * o,
                        ...
                        0 !== _.params.spaceBetween && (s() ? _.rtl ? _.slides.css({
                            marginLeft: t + "px"
                        }) : _.slides.css({
                            marginRight: t + "px"
                        }) : _.slides.css({
                    ...
                    _.updateSlidesOffset = function () {
                        for (var e = 0; e < _.slides.length; e++)
                            _.slides[e].swiperSlideOffset = s() ? _.slides[e].offsetLeft : _.slides[e].offsetTop
                    }
                    ,
                    _.updateSlidesProgress = function (e) {
                        if ("undefined" == typeof e && (e = _.translate || 0),
                            0 !== _.slides.length) {
                            "undefined" == typeof _.slides[0].swiperSlideOffset && _.updateSlidesOffset();
                            var t = -e;
                            _.rtl && (t = e),
                                _.container[0].getBoundingClientRect(),
                                s() ? "left" : "top",
                                s() ? "right" : "bottom",
                    ...
                    _.updateProgress = function (e) {
                        ...
                        _.isBeginning && _.emit("onReachBeginning", _),
                        _.isEnd && _.emit("onReachEnd", _),
                    ...
                    _.updateActiveIndex = function () {
                        ...
                        for (t = 0; t < _.slidesGrid.length; t++)
                            "undefined" != typeof _.slidesGrid[t + 1] ? n >= _.slidesGrid[t] && n < _.slidesGrid[t + 1] - (_.slidesGrid[t + 1] - _.slidesGrid[t]) / 2 ? e = t : n >= _.slidesGrid[t] && n < _.slidesGrid[t + 1] && (e = t + 1) : n >= _.slidesGrid[t] && (e = t);
                        (0 > e || "undefined" == typeof e) && (e = 0),
                            i = Math.floor(e / _.params.slidesPerGroup),
                        i >= _.snapGrid.length && (i = _.snapGrid.length - 1),
                        e !== _.activeIndex && (_.snapIndex = i,
                    ...
                    _.updateClasses = function () {
                        ...
                        if (e.addClass(_.params.slideActiveClass),
                                e.next("." + _.params.slideClass).addClass(_.params.slideNextClass),
                                e.prev("." + _.params.slideClass).addClass(_.params.slidePrevClass),
                            _.bullets && _.bullets.length > 0) {
                            _.bullets.removeClass(_.params.bulletActiveClass);
                            var i;
                            _.params.loop ? (i = Math.ceil(_.activeIndex - _.loopedSlides) / _.params.slidesPerGroup,
                            i > _.slides.length - 1 - 2 * _.loopedSlides && (i -= _.slides.length - 2 * _.loopedSlides),
                            i > _.bullets.length - 1 && (i -= _.bullets.length)) : i = "undefined" != typeof _.snapIndex ? _.snapIndex : _.activeIndex || 0,
                        ...
                        _.params.loop || (_.params.prevButton && (_.isBeginning ? (t(_.params.prevButton).addClass(_.params.buttonDisabledClass),
                        _.params.a11y && _.a11y && _.a11y.disable(t(_.params.prevButton))) : (t(_.params.prevButton).removeClass(_.params.buttonDisabledClass),
                        _.params.a11y && _.a11y && _.a11y.enable(t(_.params.prevButton)))),
                        _.params.nextButton && (_.isEnd ? (t(_.params.nextButton).addClass(_.params.buttonDisabledClass),
                        _.params.a11y && _.a11y && _.a11y.disable(t(_.params.nextButton))) : (t(_.params.nextButton).removeClass(_.params.buttonDisabledClass),
                        _.params.a11y && _.a11y && _.a11y.enable(t(_.params.nextButton)))))
                    }
                    ,
                    _.updatePagination = function () {
                        if (_.params.pagination && _.paginationContainer && _.paginationContainer.length > 0) {
                            for (var e = "", t = _.params.loop ? Math.ceil((_.slides.length - 2 * _.loopedSlides) / _.params.slidesPerGroup) : _.snapGrid.length, i = 0; t > i; i++)
                                e += _.params.paginationBulletRender ? _.params.paginationBulletRender(i, _.params.bulletClass) : "<" + _.params.paginationElement + ' class="' + _.params.bulletClass + '"></' + _.params.paginationElement + ">";
                    ...
                    _.update = function (e) {
                        ...
                        if (_.updateContainerSize(),
                            ...
                            _.controller && _.controller.spline && (_.controller.spline = void 0),
                                _.params.freeMode ? t() : (i = ("auto" === _.params.slidesPerView || _.params.slidesPerView > 1) && _.isEnd && !_.params.centeredSlides ? _.slideTo(_.slides.length - 1, 0, !1, !0) : _.slideTo(_.activeIndex, 0, !1, !0),
                                i || t())
                        }
                    }
                    ,
                    _.onResize = function (e) {
                        ...
                        if (_.params.allowSwipeToPrev = _.params.allowSwipeToNext = !0,
                ...
                (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && ("container" === _.params.touchEventsTarget ? _.container : _.wrapper).addClass("swiper-wp8-" + _.params.direction),
                    _.initEvents = function (e) {
                        var i = e ? "off" : "on"
                            ...
                            , o = !!_.params.nested;
                        _.browser.ie ? (s[n](_.touchEvents.start, _.onTouchStart, !1),
                            a[n](_.touchEvents.move, _.onTouchMove, o),
                            a[n](_.touchEvents.end, _.onTouchEnd, !1)) : (_.support.touch && (s[n](_.touchEvents.start, _.onTouchStart, !1),
                            s[n](_.touchEvents.move, _.onTouchMove, o),
                            s[n](_.touchEvents.end, _.onTouchEnd, !1)),
                        !r.simulateTouch || _.device.ios || _.device.android || (s[n]("mousedown", _.onTouchStart, !1),
                            document[n]("mousemove", _.onTouchMove, o),
                            document[n]("mouseup", _.onTouchEnd, !1))),
                            window[n]("resize", _.onResize),
                        _.params.nextButton && (t(_.params.nextButton)[i]("click", _.onClickNext),
                        _.params.a11y && _.a11y && t(_.params.nextButton)[i]("keydown", _.a11y.onEnterKey)),
                        _.params.prevButton && (t(_.params.prevButton)[i]("click", _.onClickPrev),
                        _.params.a11y && _.a11y && t(_.params.prevButton)[i]("keydown", _.a11y.onEnterKey)),
                        _.params.pagination && _.params.paginationClickable && (t(_.paginationContainer)[i]("click", "." + _.params.bulletClass, _.onClickIndex),
                        _.params.a11y && _.a11y && t(_.paginationContainer)[i]("keydown", "." + _.params.bulletClass, _.a11y.onEnterKey)),
                        (_.params.preventClicks || _.params.preventClicksPropagation) && s[n]("click", _.preventClicks, !0)
                    }
                    ,
                    ...
                    _.updateClickedSlide = function (e) {
                        ...
                        if (_.clickedSlide = i,
                                _.clickedIndex = t(i).index(),
                            _.params.slideToClickedSlide && void 0 !== _.clickedIndex && _.clickedIndex !== _.activeIndex) {
                            var s, a, o = _.clickedIndex;
                            _.params.loop ? (s = t(_.clickedSlide).attr("data-swiper-slide-index"),
                                _.params.centeredSlides ? o < _.loopedSlides - _.params.slidesPerView / 2 ? (_.fixLoop(),
                                    a = _.wrapper.children("." + _.params.slideClass + '[data-swiper-slide-index="' + s + '"]'),
                                    o = a.eq(a.length - 1).index(),
                                    setTimeout(function () {
                                        _.slideTo(o)
                                    }, 0)) : o > _.slides.length - _.loopedSlides + _.params.slidesPerView / 2 ? (_.fixLoop(),
                                    o = _.wrapper.children("." + _.params.slideClass + '[data-swiper-slide-index="' + s + '"]').eq(0).index(),
                                    setTimeout(function () {
                                        _.slideTo(o)
                                    }, 0)) : _.slideTo(o) : o > _.slides.length - _.params.slidesPerView ? (_.fixLoop(),
                                    o = _.wrapper.children("." + _.params.slideClass + '[data-swiper-slide-index="' + s + '"]').eq(0).index(),
                                    setTimeout(function () {
                                        _.slideTo(o)
                                    }, 0)) : o < _.params.slidesPerView - 1 ? (_.fixLoop(),
                                    a = _.wrapper.children("." + _.params.slideClass + '[data-swiper-slide-index="' + s + '"]'),
                                    o = a.eq(a.length - 1).index(),
                                    setTimeout(function () {
                                        _.slideTo(o)
                ...
                ;
                var w, x, b, T, S, C, P, k, D, O = "input, select, textarea, button", E = Date.now(), M = [];
                _.animating = !1,
                    _.touches = {
                        startX: 0,
                        startY: 0,
                ...
                if (_.onTouchStart = function (e) {
                        if (e.originalEvent && (e = e.originalEvent),
                            ...
                            if (_.params.noSwiping && l(e, "." + _.params.noSwipingClass))
                                ...
                                if (_.params.onlyExternal)
                                    return _.allowClick = !1,
                                        void (w && (_.touches.startX = _.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
                                            ...
                                            b = Date.now()));
                                if (A && document.activeElement && e.target === document.activeElement && t(e.target).is(O))
                                    return x = !0,
                                        void (_.allowClick = !1);
                                if (_.emit("onTouchMove", _, e),
                                    ...
                                    if (T && _.emit("onTouchMoveOpposite", _, e),
                                        "undefined" == typeof R && _.browser.ieTouch && (_.touches.currentX !== _.touches.startX || _.touches.currentY !== _.touches.startY) && (R = !0),
                                            w) {
                                        if (T)
                                            return void (w = !1);
                                        if (R || !_.browser.ieTouch) {
                                            ...
                                            _.params.autoplay && _.autoplaying && (_.params.autoplayDisableOnInteraction ? _.stopAutoplay() : _.pauseAutoplay()),
                                                D = !1,
                                            _.params.grabCursor && (_.container[0].style.cursor = "move",
                                                _.container[0].style.cursor = "-webkit-grabbing",
                                                _.container[0].style.cursor = "-moz-grabbin",
                                                _.container[0].style.cursor = "grabbing")),
                                                x = !0;
                                            ...
                                            _.rtl && (n = -n),
                                                ...
                                                S = n + C;
                                            var a = !0;
                                            if (n > 0 && S > _.minTranslate() ? (a = !1,
                                                _.params.resistance && (S = _.minTranslate() - 1 + Math.pow(-_.minTranslate() + C + n, _.params.resistanceRatio))) : 0 > n && S < _.maxTranslate() && (a = !1,
                                                _.params.resistance && (S = _.maxTranslate() + 1 - Math.pow(_.maxTranslate() - C - n, _.params.resistanceRatio))),
                                                a && (e.preventedByNestedSwiper = !0),
                                                !_.params.allowSwipeToNext && "next" === _.swipeDirection && C > S && (S = C),
                                                !_.params.allowSwipeToPrev && "prev" === _.swipeDirection && S > C && (S = C),
                                                ...
                                                if (_.params.threshold > 0) {
                                                    ...
                                                    if (!P)
                                                        return P = !0,
                                                            ...
                                                            S = C,
                                                            void (_.touches.diff = s() ? _.touches.currentX - _.touches.startX : _.touches.currentY - _.touches.startY)
                                                }
                                                (_.params.freeMode || _.params.watchSlidesProgress) && _.updateActiveIndex(),
                                                _.params.freeMode && (0 === M.length && M.push({
                        ...
                        _.onTouchEnd = function (e) {
                            if (e.originalEvent && (e = e.originalEvent),
                                    _.emit("onTouchEnd", _, e),
                                    w) {
                                _.params.grabCursor && x && w && (_.container[0].style.cursor = "move",
                                    _.container[0].style.cursor = "-webkit-grab",
                                    _.container[0].style.cursor = "-moz-grab",
                                    _.container[0].style.cursor = "grab");
                                var i = Date.now()
                                ...
                                if (_.allowClick && (_.updateClickedSlide(e),
                                        _.emit("onTap", _, e),
                                    300 > n && i - E > 300 && (k && clearTimeout(k),
                                    ...
                                    300 > n && 300 > i - E && (k && clearTimeout(k),
                                        _.emit("onDoubleTap", _, e))),
                                        E = Date.now(),
                                        setTimeout(function () {
                                            _ && (_.allowClick = !0)
                                        }, 0),
                                    !w || !x || !_.swipeDirection || 0 === _.touches.diff || S === C)
                                    return void (w = x = !1);
                                w = x = !1;
                                var r;
                                if (r = _.params.followFinger ? _.rtl ? _.translate : -_.translate : -S,
                                        _.params.freeMode) {
                                    if (r < -_.minTranslate())
                                    ...
                                    if (_.params.freeModeMomentum) {
                                        ...
                                        if (p < _.maxTranslate())
                                            _.params.freeModeMomentumBounce ? (p + _.maxTranslate() < -f && (p = _.maxTranslate() - f),
                                                h = _.maxTranslate(),
                                                d = !0,
                                                D = !0) : p = _.maxTranslate();
                                        else if (p > _.minTranslate())
                                            _.params.freeModeMomentumBounce ? (p - _.minTranslate() > f && (p = _.minTranslate() + f),
                                                h = _.minTranslate(),
                                                d = !0,
                                                D = !0) : p = _.minTranslate();
                                            ...
                                            p = Math.abs(_.snapGrid[m] - p) < Math.abs(_.snapGrid[m - 1] - p) || "next" === _.swipeDirection ? _.snapGrid[m] : _.snapGrid[m - 1],
                                            _.rtl || (p = -p)
                                        }
                                        if (0 !== _.velocity)
                                            u = _.rtl ? Math.abs((-p - _.translate) / _.velocity) : Math.abs((p - _.translate) / _.velocity);
                                        else if (_.params.freeModeSticky)
                                            return void _.slideReset();
                                        _.params.freeModeMomentumBounce && d ? (_.updateProgress(h),
                                            _.setWrapperTransition(u),
                                            _.setWrapperTranslate(p),
                                            _.onTransitionStart(),
                                            _.animating = !0,
                                            _.wrapper.transitionEnd(function () {
                                                _ && D && (_.emit("onMomentumBounce", _),
                                                    _.setWrapperTransition(_.params.speed),
                                                    _.setWrapperTranslate(h),
                                                    _.wrapper.transitionEnd(function () {
                                                        _ && _.onTransitionEnd()
                                                    }))
                                            })) : _.velocity ? (_.updateProgress(p),
                                            _.setWrapperTransition(u),
                                            _.setWrapperTranslate(p),
                                            _.onTransitionStart(),
                                    ...
                                    return void ((!_.params.freeModeMomentum || n >= _.params.longSwipesMs) && (_.updateProgress(),
                                        _.updateActiveIndex()))
                                }
                                var v, y = 0, T = _.slidesSizesGrid[0];
                                for (v = 0; v < _.slidesGrid.length; v += _.params.slidesPerGroup)
                                    "undefined" != typeof _.slidesGrid[v + _.params.slidesPerGroup] ? r >= _.slidesGrid[v] && r < _.slidesGrid[v + _.params.slidesPerGroup] && (y = v,
                                        T = _.slidesGrid[v + _.params.slidesPerGroup] - _.slidesGrid[v]) : r >= _.slidesGrid[v] && (y = v,
                                        T = _.slidesGrid[_.slidesGrid.length - 1] - _.slidesGrid[_.slidesGrid.length - 2]);
                                var P = (r - _.slidesGrid[y]) / T;
                                if (n > _.params.longSwipesMs) {
                                    if (!_.params.longSwipes)
                                        return void _.slideTo(_.activeIndex);
                                    "next" === _.swipeDirection && (P >= _.params.longSwipesRatio ? _.slideTo(y + _.params.slidesPerGroup) : _.slideTo(y)),
                                    "prev" === _.swipeDirection && (P > 1 - _.params.longSwipesRatio ? _.slideTo(y + _.params.slidesPerGroup) : _.slideTo(y))
                                } else {
                        ...
                        _.slideTo = function (e, t, i, n) {
                            ...
                            return !(!_.params.allowSwipeToNext && r < _.translate && r < _.minTranslate()) && (!(!_.params.allowSwipeToPrev && r > _.translate && r > _.maxTranslate() && (_.activeIndex || 0) !== e) && ("undefined" == typeof t && (t = _.params.speed),
                                _.previousIndex = _.activeIndex || 0,
                                _.activeIndex = e,
                                r === _.translate ? (_.updateClasses(),
                                    !1) : (_.updateClasses(),
                                    _.onTransitionStart(i),
                                    s() ? r : 0,
                                    s() ? 0 : r,
                                    0 === t ? (_.setWrapperTransition(0),
                                        _.setWrapperTranslate(r),
                                        _.onTransitionEnd(i)) : (_.setWrapperTransition(t),
                                        _.setWrapperTranslate(r),
                                    _.animating || (_.animating = !0,
                                        _.wrapper.transitionEnd(function () {
                        ...
                        _.slideNext = function (e, t, i) {
                            return _.params.loop ? !_.animating && (_.fixLoop(),
                                _.container[0].clientLeft,
                                _.slideTo(_.activeIndex + _.params.slidesPerGroup, t, e, i)) : _.slideTo(_.activeIndex + _.params.slidesPerGroup, t, e, i)
                        }
                        ,
                        ...
                        _.slidePrev = function (e, t, i) {
                            return _.params.loop ? !_.animating && (_.fixLoop(),
                                _.container[0].clientLeft,
                                _.slideTo(_.activeIndex - 1, t, e, i)) : _.slideTo(_.activeIndex - 1, t, e, i)
                        }
                        ,
                        ...
                        _.setWrapperTranslate = function (e, t, i) {
                            var n = 0
                                ...
                                , o = 0;
                            s() ? n = _.rtl ? -e : e : r = e,
                            _.params.roundLengths && (n = a(n),
                                r = a(r)),
                            _.params.virtualTranslate || (_.support.transforms3d ? _.wrapper.transform("translate3d(" + n + "px, " + r + "px, " + o + "px)") : _.wrapper.transform("translate(" + n + "px, " + r + "px)")),
                                _.translate = s() ? n : r,
                        ...
                        _.createLoop = function () {
                            ...
                            for (e.each(function (i, s) {
                                var a = t(this);
                                i < _.loopedSlides && r.push(s),
                                i < e.length && i >= e.length - _.loopedSlides && n.push(s),
                                    a.attr("data-swiper-slide-index", i)
                            }),
                                     i = 0; i < r.length; i++)
                                _.wrapper.append(t(r[i].cloneNode(!0)).addClass(_.params.slideDuplicateClass));
                            for (i = n.length - 1; i >= 0; i--)
                                _.wrapper.prepend(t(n[i].cloneNode(!0)).addClass(_.params.slideDuplicateClass))
                        }
                        ,
                        ...
                        _.effects = {
                            ...
                            cube: {
                                setTranslate: function () {
                                    var e, i = 0;
                                    _.params.cube.shadow && (s() ? (e = _.wrapper.find(".swiper-cube-shadow"),
                                    ...
                                    for (var n = 0; n < _.slides.length; n++) {
                                        ...
                                        n % 4 === 0 ? (u = 4 * -o * _.size,
                                            p = 0) : (n - 1) % 4 === 0 ? (u = 0,
                                            p = 4 * -o * _.size) : (n - 2) % 4 === 0 ? (u = _.size + 4 * o * _.size,
                                            p = _.size) : (n - 3) % 4 === 0 && (u = -_.size,
                                            p = 3 * _.size + 4 * _.size * o),
                                        _.rtl && (u = -u),
                                        s() || (c = u,
                                            u = 0);
                                        var h = "rotateX(" + (s() ? 0 : -a) + "deg) rotateY(" + (s() ? a : 0) + "deg) translate3d(" + u + "px, " + c + "px, " + p + "px)";
                                        if (1 >= l && l > -1 && (i = 90 * n + 90 * l,
                                            _.rtl && (i = 90 * -n - 90 * l)),
                                                r.transform(h),
                                            ...
                                            0 === d.length && (d = t('<div class="swiper-slide-shadow-' + (s() ? "left" : "top") + '"></div>'),
                                                r.append(d)),
                                            0 === f.length && (f = t('<div class="swiper-slide-shadow-' + (s() ? "right" : "bottom") + '"></div>'),
                                                r.append(f)),
                                                r[0].progress,
                                            d.length && (d[0].style.opacity = -r[0].progress),
                                ...
                                setTransition: function (e) {
                                    ...
                                    _.params.cube.shadow && !s() && _.container.find(".swiper-cube-shadow").transition(e)
                                }
                            },
                            coverflow: {
                                setTranslate: function () {
                                    for (var e = _.translate, i = s() ? -e + _.width / 2 : -e + _.height / 2, n = s() ? _.params.coverflow.rotate : -_.params.coverflow.rotate, r = _.params.coverflow.depth, a = 0, o = _.slides.length; o > a; a++) {
                                        ...
                                        if (l.transform(v),
                                                l[0].style.zIndex = -Math.abs(Math.round(p)) + 1,
                                            ...
                                            0 === y.length && (y = t('<div class="swiper-slide-shadow-' + (s() ? "left" : "top") + '"></div>'),
                                                l.append(y)),
                                            0 === w.length && (w = t('<div class="swiper-slide-shadow-' + (s() ? "right" : "bottom") + '"></div>'),
                                                l.append(w)),
                        ...
                        _.lazy = {
                            ...
                            loadImageInSlide: function (e, i) {
                                if ("undefined" != typeof e && ("undefined" == typeof i && (i = !0),
                                    ...
                                    !n.hasClass("swiper-lazy") || n.hasClass("swiper-lazy-loaded") || n.hasClass("swiper-lazy-loading") || r.add(n[0]),
                            ...
                            load: function () {
                                ...
                                if (_.params.watchSlidesVisibility)
                                    ...
                                    for (e = _.activeIndex; e < _.activeIndex + _.params.slidesPerView; e++)
                                ...
                                if (_.params.lazyLoadingInPrevNext)
                                    if (_.params.slidesPerView > 1) {
                                        for (e = _.activeIndex + _.params.slidesPerView; e < _.activeIndex + _.params.slidesPerView + _.params.slidesPerView; e++)
                                            _.slides[e] && _.lazy.loadImageInSlide(e);
                                        for (e = _.activeIndex - _.params.slidesPerView; e < _.activeIndex; e++)
                                            _.slides[e] && _.lazy.loadImageInSlide(e)
                                    } else {
                        ...
                        _.scrollbar = {
                            ...
                            setTranslate: function () {
                                if (_.params.scrollbar) {
                                    var e, t = _.scrollbar, i = (_.translate || 0,
                                        t.dragSize);
                                    e = (t.trackSize - t.dragSize) * _.progress,
                                        ...
                                        s() ? (_.support.transforms3d ? t.drag.transform("translate3d(" + e + "px, 0, 0)") : t.drag.transform("translateX(" + e + "px)"),
                                            t.drag[0].style.width = i + "px") : (_.support.transforms3d ? t.drag.transform("translate3d(0px, " + e + "px, 0)") : t.drag.transform("translateY(" + e + "px)"),
                        ...
                        _.controller = {
                            ...
                            setTranslate: function (e, t) {
                                function n(t) {
                                    ...
                                    "slide" === _.params.controlBy && (_.controller.getInterpolateFunction(t),
                                        s = -_.controller.spline.interpolate(-e)),
                                    s && "container" !== _.params.controlBy || (r = (t.maxTranslate() - t.minTranslate()) / (_.maxTranslate() - _.minTranslate()),
                                        s = (e - _.minTranslate()) * r + t.minTranslate()),
                                ...
                                function n(t) {
                                    ...
                                    0 !== e && (t.onTransitionStart(),
                                        t.wrapper.transitionEnd(function () {
                                            s && (t.params.loop && "slide" === _.params.controlBy && t.fixLoop(),
                                                t.onTransitionEnd())
                                        }))
                                }
                ...
                _.disableMousewheelControl = function () {
                    return !!_.mousewheel.event && (_.container.off(_.mousewheel.event, p),
                        !0)
                }
                    ,
                    _.enableMousewheelControl = function () {
                        return !!_.mousewheel.event && (_.container.on(_.mousewheel.event, p),
                            !0)
                    }
                    ,
                    _.parallax = {
                    ...
                    _.off = function (e, t) {
                        ...
                        if (_.emitterEventListeners[e] && 0 !== _.emitterEventListeners[e].length) {
                            for (i = 0; i < _.emitterEventListeners[e].length; i++)
                                _.emitterEventListeners[e][i] === t && _.emitterEventListeners[e].splice(i, 1);
                            return _
                        }
                    }
                    ,
        ...
        for (var n = (function () {
            ...
            return e.prototype = {
                ...
                on: function (e, i, n, r) {
                    function s(e) {
                        ...
                        if (t(r).is(i))
                            ...
                            for (var s = t(r).parents(), a = 0; a < s.length; a++)
                                t(s[a]).is(i) && n.call(s[a], e)
                    }
                    ...
                    for (a = 0; a < this.length; a++)
                        if ("function" == typeof i || i === !1)
                            for ("function" == typeof i && (n = arguments[1],
                                r = arguments[2] || !1),
                                     o = 0; o < l.length; o++)
                                this[a].addEventListener(l[o], n, r);
                        else
                        ...
                        for (var a = 0; a < this.length; a++)
                            if ("function" == typeof t || t === !1)
                                "function" == typeof t && (i = arguments[1],
                                    n = arguments[2] || !1),
                                    this[a].removeEventListener(r[s], i, n);
                            else if (this[a].dom7LiveListeners)
                                for (var o = 0; o < this[a].dom7LiveListeners.length; o++)
                                    this[a].dom7LiveListeners[o].listener === i && this[a].removeEventListener(r[s], this[a].dom7LiveListeners[o].liveListener, n);
                    return this
                },
                ...
                insertAfter: function (e) {
                    for (var i = t(e), n = 0; n < this.length; n++)
                        if (1 === i.length)
                            ...
                            for (var r = 0; r < i.length; r++)
                                i[r].parentNode.insertBefore(this[n].cloneNode(!0), i[r].nextSibling)
                },
                next: function (i) {
                ...
                find: function (t) {
                    for (var i = [], n = 0; n < this.length; n++)
                        for (var r = this[n].querySelectorAll(t), s = 0; s < r.length; s++)
                            i.push(r[s]);
                    return new e(i)
                },
                children: function (i) {
                    for (var n = [], r = 0; r < this.length; r++)
                        for (var s = this[r].childNodes, a = 0; a < s.length; a++)
                            i ? 1 === s[a].nodeType && t(s[a]).is(i) && n.push(s[a]) : 1 === s[a].nodeType && n.push(s[a]);
        ...
        var a;
        a = "undefined" == typeof n ? window.Dom7 || window.Zepto || window.jQuery : n,
...
var appLang = $("html").attr("lang"), $body = $("body"), wH, wW, pixelDensity = window.devicePixelRatio || 1,
    dragging = !1, scrolling = !1, transitioning = !1, transitionTimer, onResizeTimer,
    mobile = !!/iPhone|iPad|iPod|Android|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
    isIE9 = !!$("html").hasClass("ie9"), isiOS = !!navigator.userAgent.match(/(iPad|iPhone|iPod)/g),
    isiOS8 = navigator.userAgent.match(/(iPad|iPhone|iPod).*OS 8_\d/i),
    isChrome = navigator.userAgent.indexOf("Chrome") > -1, isExplorer = navigator.userAgent.indexOf("MSIE") > -1,
    isFirefox = navigator.userAgent.indexOf("Firefox") > -1, isSafari = navigator.userAgent.indexOf("Safari") > -1,
    isOpera = navigator.userAgent.indexOf("Presto") > -1;
isChrome && isSafari && (isSafari = !1);
var mousewheelevt = /Firefox/i.test(navigator.userAgent) ? "DOMMouseScroll" : "wheel", sections = [],
    currentSection = 0, trValues = [], timelineCtn = $("#timeline-ctn"), listItems = $("section"),
    stripe = document.getElementById("stripe"), iPhone = $("#video-container"), iPhoneTransVal, slider,
    lastSwipeProgress, lastViableProgress, slidesNumber, touchmoveDisabled = !1, tabletScroll = new TabletScroll,
    submitBtn = $("#newsletter-form button");

//鼠标滚轮事件，只对740宽度以上屏幕生效
$(document).bind(mousewheelevt, function (e) {
    ...
    $(document).on("click touchend", ".nav-btn", function (e) {
        if (e.preventDefault(),
            !transitioning && !$(this).is(":disabled")) {
            transitioning = !0,
                $(".nav-btn").prop("disabled", !1);
    ...
    $(document).on("click touchend", ".newsletter-btn", function (e) {
        ...
        wW <= 740 ? TweenMax.to(window, .8, {
            ...
            ease: Quad.easeInOut
        }) : currentSection === sections.length - 1 || transitioning || (transitioning = !0,
            currentSection = sections.length - 1,
            sections[currentSection].animate(!0, !0))
    }),
    $(document).on("submit", "#newsletter-form", function (e) {
        e.preventDefault(),
        submitBtn.is(":disabled") || sendForm()
    }),
